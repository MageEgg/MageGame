    ...
    function BoxShowResources(int pid,int id)
        ...
        elseif  id == 652 or id == 653
            ...
            elseif  id == 653 //商城通行证
                ...
                elseif  step == 5
                    if  DzShop(Player(pid),"RWK6") == false
                        SetTipsData(10,"","|cffffcc00狂傲通行证|r|cffff0000(商城购买后激活)|r")
                    else
                        if  lv >= 20
                            SetTipsData(10,"","|cffffcc00狂傲通行证|r.Lv"+I2S(lv)+"(|cff00ff00已满级)")
                        else
                            SetTipsData(10,"","|cffffcc00狂傲通行证|r.Lv"+I2S(lv)+"(|cffff0000"+I2S(exp)+"/6|r)")
                            SetTipsData(11,"","距离升级还差|cffff0000"+I2S(6-exp)+"|r经验")
                        endif
                    endif
                endif

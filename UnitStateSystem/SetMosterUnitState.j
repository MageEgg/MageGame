library UnitStateSet uses State
    ...
    function UnitStateSetInit()
        ...
        elseif  GameMode == 4
            InitMostetStateRatio(1,100,90)
            InitMostetStateRatio(2,300,200)
            InitMostetStateRatio(3,700,300)
            InitMostetStateRatio(4,1400,420)
            InitMostetStateRatio(5,2700,750)
            InitMostetStateRatio(6,2700,1200)
            InitMostetStateRatio(7,2700,1750)
        else
            InitMostetStateRatio(1,0,50)
            InitMostetStateRatio(2,0,50)
            InitMostetStateRatio(3,0,65)

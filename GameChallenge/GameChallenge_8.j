library GameChallenge8 uses GameChallengeBase
            ...
            if  IsPlayerInChallenge == true
                if  time == 1
                    ...
                    if  num != 0
                        x = 1952
                        y = 6720
                        CreateUsesGameChallengeUnitExOfAng(pid,num,'uf87',x,y,270)
                ...
                elseif  time == 2
                    ...
                    x = x + 300*Cos(ang)
                    y = y + 300*Sin(ang)
                    SetUnitPositionOfGameChalleng(GameChallengeUnit[num],x,y)
                    SetUnitFacing(GameChallengeUnit[num],ang/0.01745)
            ...
            if  IsPlayerInChallenge == true
                ...
                elseif  time == 3
                    ...
                    if  num != 0
                        ...
                        y = 7808
                        ang = Atan2(GetUnitY(Pu[1])-y,GetUnitX(Pu[1])-x)
                        CreateUsesGameChallengeUnitExOfAng(pid,num,'uf80',x,y,ang/0.01745)
                        UnitAddEffectOfGameChalleng(GameChallengeUnit[num])
                        UnitAddEffectSetSize(GameChallengeUnit[num],"effect_az-leiji.mdx",2)
                        SetUnitAnimation(GameChallengeUnit[num],"attack")
                    endif
                elseif  time == 4
                    SetUnitVertexColor(GameChallengeUnit[82],255,255,255,0)
                    SetUnitVertexColor(GameChallengeUnit[83],255,255,255,0)
                    UnitAddEffectSetSize(GameChallengeUnit[num],"effect_az-leiji.mdx",2)
                    SetUnitOwner(GameChallengeUnit[num],Player(pid+4),true)
                    SetUnitColor(GameChallengeUnit[num],GetPlayerColor(Player(PLAYER_NEUTRAL_AGGRESSIVE)))
                    IssuePointOrderById(GameChallengeUnit[num],851983,GetUnitX(Pu[1]),GetUnitY(Pu[1]))
            ...
            if  IsPlayerInChallenge == true
                if  time == 1
                    ...
                    if  num != 0
                        ...
                        y = 8224
                        ang = Atan2(GetUnitY(Pu[1])-y,GetUnitX(Pu[1])-x)
                        CreateUsesGameChallengeUnitExOfAng(pid,num,'uf81',x,y,ang/0.01745)
                        UnitAddEffectOfGameChalleng(GameChallengeUnit[num])
                        UnitAddEffectSetSize(GameChallengeUnit[num],"effect_az-leiji.mdx",2)
                        SetUnitAnimation(GameChallengeUnit[num],"attack")
                    endif
            ...
            if  IsPlayerInChallenge == true
                if  time == 1
                    ...
                    if  num != 0
                        ...
                        y = 8064
                        ang = Atan2(GetUnitY(Pu[1])-y,GetUnitX(Pu[1])-x)
                        CreateUsesGameChallengeUnitExOfAng(pid,num,'uf82',x,y,ang/0.01745)
                        UnitAddEffectOfGameChalleng(GameChallengeUnit[num])
                        UnitAddEffectSetSize(GameChallengeUnit[num],"effect_az-leiji.mdx",2)
                        SetUnitAnimation(GameChallengeUnit[num],"attack")
                    endif
            ...
            if  IsPlayerInChallenge == true
                if  time == 1
                    ...
                    if  num != 0
                        ...
                        y = 7584
                        ang = Atan2(GetUnitY(Pu[1])-y,GetUnitX(Pu[1])-x)
                        CreateUsesGameChallengeUnitExOfAng(pid,num,'uf83',x,y,ang/0.01745)
                        UnitAddEffectOfGameChalleng(GameChallengeUnit[num])
                        UnitAddEffectSetSize(GameChallengeUnit[num],"effect_az-leiji.mdx",2)
                        SetUnitAnimation(GameChallengeUnit[num],"attack")
                    endif
            ...
            if  IsPlayerInChallenge == true
                if  time == 1
                    ...
                    if  num != 0
                        ...
                        y = 6880
                        ang = Atan2(GetUnitY(Pu[1])-y,GetUnitX(Pu[1])-x)
                        CreateUsesGameChallengeUnitExOfAng(pid,num,'uf84',x,y,ang/0.01745)
                        UnitAddEffectOfGameChalleng(GameChallengeUnit[num])
                        UnitAddEffectSetSize(GameChallengeUnit[num],"effect_az-leiji.mdx",2)
                        SetUnitAnimation(GameChallengeUnit[num],"attack")
                    endif
            ...
            if  IsPlayerInChallenge == true
                if  time == 1
                    ...
                    if  num != 0
                        ...
                        y = 6464
                        ang = Atan2(GetUnitY(Pu[1])-y,GetUnitX(Pu[1])-x)
                        CreateUsesGameChallengeUnitExOfAng(pid,num,'uf85',x,y,ang/0.01745)
                        UnitAddEffectOfGameChalleng(GameChallengeUnit[num])
                        UnitAddEffectSetSize(GameChallengeUnit[num],"effect_az-leiji.mdx",2)
                        SetUnitAnimation(GameChallengeUnit[num],"attack")
                    endif
            ...
            if  IsPlayerInChallenge == true
                if  time == 1
                    ...
                    if  num != 0
                        ...
                        y = 8448
                        ang = Atan2(GetUnitY(Pu[1])-y,GetUnitX(Pu[1])-x)
                        CreateUsesGameChallengeUnitExOfAng(pid,num,'uf86',x,y,ang/0.01745)
                        UnitAddEffectOfGameChalleng(GameChallengeUnit[num])
                        UnitAddEffectSetSize(GameChallengeUnit[num],"effect_az-leiji.mdx",2)
                        SetUnitAnimation(GameChallengeUnit[num],"attack")
                    endif
    ...
    function OpenGameChallenge_8(int pid,int ty)
        ...
        if  ty == 0
            ...
            ShowHeroGetTask(pid)
            GameChallengeInt[80] = 1
            ShowUnitOfOnlyPlayer(pid,GameChallengeUnit[82],UnitAPOfPlayer)
            UnitAddEffectOfGameChalleng(GameChallengeUnit[82])
            ShowUnitOfOnlyPlayer(pid,GameChallengeUnit[83],UnitAPOfPlayer)
        ...
        elseif  ty == 1
            ...
            SendPlayerUnit(pid,x,y)
            ShowHeroGetTask(pid)
            GameChallengeInt[80] = 100
            ShowUnitOfOnlyPlayer(pid,GameChallengeUnit[80],UnitAPOfPlayer)
            UnitAddEffectOfGameChalleng(GameChallengeUnit[80])
            ShowUnitOfOnlyPlayer(pid,GameChallengeUnit[81],UnitAPOfPlayer)
    ...
    function GameChallenge_8_Death(int pid,unit u2)
        ...
        elseif  uid == 'uf87'
            ...
            if  GameChallengeOperaWay[8] == 0
                if  GetGameChallengOperaSelsect() == 0
                    GameChallengeOperaWay[8] = 1
    ...
    function InitGameChallenge_8()
        for pid = 0,3
            if  IsPlaying(pid) == true
                GameChallengeUnit[80] = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE),'np07',1728,6112,45)
                SetUnitVertexColor(GameChallengeUnit[80],255,255,255,0)
                EXSetUnitMoveType(GameChallengeUnit[80],0x01)
                GameChallengeUnit[81] = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE),'eZ08',1728,6112,0)
                SetUnitVertexColor(GameChallengeUnit[81],255,255,255,0)
                EXSetUnitMoveType(GameChallengeUnit[81],0x01)
                GameChallengeUnit[82] = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE),'np07',2592,7800,270)
                SetUnitVertexColor(GameChallengeUnit[82],255,255,255,0)
                EXSetUnitMoveType(GameChallengeUnit[82],0x01)
                GameChallengeUnit[83] = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE),'eZ08',2592,7800,0)
                SetUnitVertexColor(GameChallengeUnit[83],255,255,255,0)
                EXSetUnitMoveType(GameChallengeUnit[83],0x01)
            endif
        end
    endfunction

library GameChallenge11 uses GameChallengeBase
    ...
    function InitGameChallengeWM_M()
        InitGameChallengeWM_MDate(1,1,1,2,33,6)
        InitGameChallengeWM_MDate(2,1.19,1.09,2,33,6)
        InitGameChallengeWM_MDate(3,1.42,1.2,2,33,6)
        InitGameChallengeWM_MDate(4,1.69,1.31,2,33,6)
        InitGameChallengeWM_MDate(5,3.1,1.93,5,100,18)
        InitGameChallengeWM_MDate(6,3.63,2.14,2,33,6)
        InitGameChallengeWM_MDate(7,4.3,2.42,2,33,6)
        InitGameChallengeWM_MDate(8,4.7,2.63,2,33,6)
        InitGameChallengeWM_MDate(9,5.62,3.11,2,33,6)
        InitGameChallengeWM_MDate(10,10.12,4.93,5,100,50)
        InitGameChallengeWM_MDate(11,12.51,5.5,2,33,6)
        InitGameChallengeWM_MDate(12,15.48,6.15,2,33,6)
        InitGameChallengeWM_MDate(13,19.14,6.86,2,33,6)
        InitGameChallengeWM_MDate(14,24.33,7.78,2,33,6)
        InitGameChallengeWM_MDate(15,44.1,10.53,5,100,18)
        InitGameChallengeWM_MDate(16,51.87,11.43,2,33,6)
        InitGameChallengeWM_MDate(17,63.53,12.75,2,33,6)
        InitGameChallengeWM_MDate(18,76.97,14.19,2,33,6)
        InitGameChallengeWM_MDate(19,93.24,15.8,2,33,6)
        InitGameChallengeWM_MDate(20,175.21,22.15,5,100,50)
        InitGameChallengeWM_MDate(21,197.36,23.42,2,33,10)
        InitGameChallengeWM_MDate(22,222.3,24.77,2,33,10)
        InitGameChallengeWM_MDate(23,250.4,26.2,2,33,10)
        InitGameChallengeWM_MDate(24,283.33,27.8,2,33,10)
        InitGameChallengeWM_MDate(25,389.43,32.65,5,100,50)
        InitGameChallengeWM_MDate(26,429.48,34.31,2,33,10)
        InitGameChallengeWM_MDate(27,463.29,35.5,2,33,10)
        InitGameChallengeWM_MDate(28,499.77,36.74,2,33,10)
        InitGameChallengeWM_MDate(29,539.13,38.02,2,33,10)
        InitGameChallengeWM_MDate(30,798.16,51.52,5,100,50)
        InitGameChallengeWM_MDate(31,916.84,59.18,2,33,10)
        InitGameChallengeWM_MDate(32,1053.17,67.98,2,33,10)
        InitGameChallengeWM_MDate(33,1209.78,78.09,2,33,10)
        InitGameChallengeWM_MDate(34,1389.67,89.7,2,33,10)
        InitGameChallengeWM_MDate(35,2310.29,149.13,5,100,50)
        InitGameChallengeWM_MDate(36,2653.83,171.31,2,33,10)
        InitGameChallengeWM_MDate(37,3048.45,196.78,2,33,10)
        InitGameChallengeWM_MDate(38,3501.75,226.04,2,33,10)
        InitGameChallengeWM_MDate(39,4022.45,259.65,2,33,10)
        InitGameChallengeWM_MDate(40,6687.23,431.67,5,100,50)
        InitGameChallengeWM_MDate(41,6687.23,431.67,2,33,10)
    endfunction

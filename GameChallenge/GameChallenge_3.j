        ...
        if  GameChallengInt[30] == 4
            ...
            if  GameChallengOperaWay[3] == 0
                if  GetGameChallengOperaSelsect() == 0
                    ...
                    DisplayTimedTextToPlayer(Player(pid),0,0,10,"|cffffcc00[剧情]：|r自此一战，黄天化心性收敛，知进退，明时务。")
                    ...
                    DisplayTimedTextToPlayer(Player(pid),0,0,10,"|cffffcc00[剧情]：|r黄天化心性草率，后于金鸡岭战败，被孔宣收服。")
            ...
            if  time < 4 and IsPlayerInChallenge == true
                ...
                if  num != 0
                    ...
                    elseif  time == 4
                        ...
                        x = -3680
                        y = 6368
                        DisplayTimedTextToPlayer(Player(pid),0,0,10,"|cffffcc00[黄天化]：|r今日定见雌雄！")
                    endif
                ...
                DisplayTimedTextToPlayer(Player(pid),0,0,10,"|cffffcc00[任务目标]：|r|cff00ffff击杀四魔将|r")
                endtimer
            endif
            flush locals
        }
    ...
    function EnRctGameChalleng_3_SMJ()
        ...
        if  GetUnitAbilityLevel(u1,'Aloc') == 0
            if  u1 == GameChallengUnit[39]
                ...
                DisplayTimedTextToPlayer(Player(pid),0,0,10,"|cffffcc00[道德真君]：|r你速往西岐，再会魔家四将，可成大功！")
                DisplayTimedTextToPlayer(Player(pid),0,0,10,"|cffffcc00[任务目标]：|r|cff00ffff跟随黄天化|r")

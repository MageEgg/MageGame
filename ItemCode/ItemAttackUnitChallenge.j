library ItemAttackUnitChallenge uses DamageCode,ItemGameFunc
    ...
    function InitAttackUnitChallengeState()
        ...
        */
        ...
        //山灵
        InitAttackUnitChallengeCombatData(1,0,450,2400,6400,12000,22000,38000,64000,120000,200000,260000,450000,700000)
        InitAttackUnitChallengeCombatData(2,0,680,3600,9500,18000,33000,56000,96000,180000,300000,390000,680000,1100000)
        InitAttackUnitChallengeCombatData(3,0,990,5200,14000,26000,48000,82000,150000,260000,440000,570000,990000,1600000)
        InitAttackUnitChallengeCombatData(4,0,1500,7500,21000,37000,69000,120000,210000,380000,630000,830000,1500000,2300000)
        InitAttackUnitChallengeCombatData(5,0,2000,11000,28000,51000,95000,170000,290000,520000,870000,1200000,2000000,3100000)
        InitAttackUnitChallengeCombatData(6,0,2700,15000,38000,70000,130000,230000,390000,710000,1200000,1600000,2700000,4200000)
        InitAttackUnitChallengeCombatData(7,0,3600,19000,50000,90000,170000,300000,500000,920000,1600000,2100000,3600000,5500000)
        //武灵
        InitAttackUnitChallengeCombatData(1,50,2200,6900,15000,31000,59000,130000,220000,350000,630000,1200000,0,0)
        InitAttackUnitChallengeCombatData(2,50,3300,11000,23000,47000,89000,190000,320000,520000,950000,1800000,0,0)
        InitAttackUnitChallengeCombatData(3,50,4900,16000,33000,68000,130000,270000,470000,760000,1400000,2600000,0,0)
        InitAttackUnitChallengeCombatData(4,50,7000,23000,48000,99000,190000,400000,680000,1200000,2100000,3800000,0,0)
        InitAttackUnitChallengeCombatData(5,50,9700,31000,66000,140000,260000,540000,930000,1600000,2800000,5200000,0,0)
        InitAttackUnitChallengeCombatData(6,50,14000,42000,90000,190000,360000,740000,1300000,2100000,3800000,7000000,0,0)
        InitAttackUnitChallengeCombatData(7,50,18000,54000,120000,250000,460000,960000,1700000,2700000,5000000,9100000,0,0)
        //符印
        InitAttackUnitChallengeCombatData(1,150,44000,110000,220000,430000,430000,720000,1400000,1900000,0,0,0,0)
        InitAttackUnitChallengeCombatData(2,150,65000,160000,330000,640000,640000,1100000,2000000,2800000,0,0,0,0)
        InitAttackUnitChallengeCombatData(3,150,95000,240000,480000,940000,940000,1600000,2900000,4100000,0,0,0,0)
        InitAttackUnitChallengeCombatData(4,150,140000,350000,690000,1400000,1400000,2400000,4200000,5900000,0,0,0,0)
        InitAttackUnitChallengeCombatData(5,150,190000,470000,950000,1900000,1900000,3200000,5800000,8100000,0,0,0,0)
        InitAttackUnitChallengeCombatData(6,150,260000,640000,1300000,2600000,2600000,4400000,7900000,12000000,0,0,0,0)
        InitAttackUnitChallengeCombatData(7,150,340000,830000,1700000,3400000,3400000,5700000,11000000,15000000,0,0,0,0)

        //境界
        InitAttackUnitChallengeCombatData(1,250,450,2700,6900,12000,35000,71000,150000,520000,920000,1600000,0,0)
        InitAttackUnitChallengeCombatData(2,250,680,4100,11000,17000,52000,110000,230000,770000,1400000,2400000,0,0)
        InitAttackUnitChallengeCombatData(3,250,990,6000,16000,25000,76000,160000,330000,1200000,2100000,3500000,0,0)
        InitAttackUnitChallengeCombatData(4,250,1500,8700,23000,36000,110000,230000,480000,1700000,3000000,5100000,0,0)
        InitAttackUnitChallengeCombatData(5,250,2000,12000,31000,49000,160000,310000,660000,2300000,4100000,7000000,0,0)
        InitAttackUnitChallengeCombatData(6,250,2700,17000,42000,67000,210000,430000,900000,3100000,5600000,9600000,0,0)
        InitAttackUnitChallengeCombatData(7,250,3600,22000,54000,87000,270000,550000,1200000,4100000,7200000,13000000,0,0)

        //挑战0
        InitAttackUnitChallengeCombatData(1,300,140,320,540,860,3600,5400,7800,11000,0,0,0,0)
        InitAttackUnitChallengeCombatData(2,300,210,480,810,1300,5400,8100,12000,16000,0,0,0,0)
        InitAttackUnitChallengeCombatData(3,300,310,700,1200,1900,7900,12000,17000,23000,0,0,0,0)
        InitAttackUnitChallengeCombatData(4,300,450,1100,1800,2800,12000,18000,25000,33000,0,0,0,0)
        InitAttackUnitChallengeCombatData(5,300,620,1400,2400,3800,16000,24000,34000,45000,0,0,0,0)
        InitAttackUnitChallengeCombatData(6,300,840,2000,3300,5200,22000,33000,47000,61000,0,0,0,0)
        InitAttackUnitChallengeCombatData(7,300,1100,2500,4300,6700,28000,42000,61000,79000,0,0,0,0)
        //挑战1
        InitAttackUnitChallengeCombatData(1,310,15000,24000,35000,50000,74000,130000,210000,260000,0,0,0,0)
        InitAttackUnitChallengeCombatData(2,310,22000,36000,52000,75000,110000,200000,310000,390000,0,0,0,0)
        InitAttackUnitChallengeCombatData(3,310,32000,52000,76000,110000,170000,290000,450000,570000,0,0,0,0)
        InitAttackUnitChallengeCombatData(4,310,46000,75000,110000,160000,240000,420000,650000,830000,0,0,0,0)
        InitAttackUnitChallengeCombatData(5,310,63000,110000,160000,220000,330000,570000,890000,1200000,0,0,0,0)
        InitAttackUnitChallengeCombatData(6,310,86000,150000,210000,300000,440000,780000,1300000,1600000,0,0,0,0)
        InitAttackUnitChallengeCombatData(7,310,120000,190000,270000,390000,570000,1100000,1600000,2100000,0,0,0,0)

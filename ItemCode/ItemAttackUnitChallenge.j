library ItemAttackUnitChallenge uses DamageCode,ItemGameFunc
    ...
    function InitAttackUnitChallengeState()
        ...
        */
        ...
        //符印
        InitAttackUnitChallengeCombatData(1,150,64000,140000,240000,520000,440000,690000,1100000,1400000,0,0,0,0)
        InitAttackUnitChallengeCombatData(2,150,78000,170000,300000,640000,540000,840000,1400000,1700000,0,0,0,0)
        InitAttackUnitChallengeCombatData(3,150,120000,250000,440000,950000,810000,1300000,2000000,2500000,0,0,0,0)
        InitAttackUnitChallengeCombatData(4,150,170000,370000,640000,1400000,1200000,1900000,2900000,3600000,0,0,0,0)
        InitAttackUnitChallengeCombatData(5,150,250000,530000,940000,2100000,1800000,2700000,4300000,5300000,0,0,0,0)
        InitAttackUnitChallengeCombatData(6,150,340000,730000,1300000,2800000,2400000,3700000,5800000,7200000,0,0,0,0)
        InitAttackUnitChallengeCombatData(7,150,460000,980000,1800000,3800000,3200000,5000000,7900000,9800000,0,0,0,0)

        //境界
        InitAttackUnitChallengeCombatData(1,250,260,2100,8400,14000,49000,96000,180000,520000,830000,1300000,0,0)
        InitAttackUnitChallengeCombatData(2,250,320,2600,11000,17000,60000,120000,220000,640000,1100000,1600000,0,0)
        InitAttackUnitChallengeCombatData(3,250,480,3900,16000,26000,90000,180000,330000,950000,1600000,2300000,0,0)
        InitAttackUnitChallengeCombatData(4,250,700,5600,23000,37000,140000,260000,480000,1400000,2200000,3300000,0,0)
        InitAttackUnitChallengeCombatData(5,250,1100,8100,33000,54000,190000,380000,700000,2100000,3300000,4800000,0,0)
        InitAttackUnitChallengeCombatData(6,250,1400,12000,45000,73000,270000,510000,960000,2800000,4400000,6600000,0,0)
        InitAttackUnitChallengeCombatData(7,250,1900,16000,61000,99000,360000,690000,1300000,3800000,6000000,9000000,0,0)

        //挑战0
        InitAttackUnitChallengeCombatData(1,300,41,160,340,560,3900,6400,9300,13000,0,0,0,0)
        InitAttackUnitChallengeCombatData(2,300,50,200,410,690,4700,7800,12000,16000,0,0,0,0)
        InitAttackUnitChallengeCombatData(3,300,75,290,620,1100,7000,12000,17000,23000,0,0,0,0)
        InitAttackUnitChallengeCombatData(4,300,110,420,900,1500,11000,17000,25000,34000,0,0,0,0)
        InitAttackUnitChallengeCombatData(5,300,160,610,1400,2200,15000,25000,36000,49000,0,0,0,0)
        InitAttackUnitChallengeCombatData(6,300,220,840,1800,3000,21000,34000,50000,67000,0,0,0,0)
        InitAttackUnitChallengeCombatData(7,300,300,1200,2500,4100,28000,46000,67000,90000,0,0,0,0)
        //挑战1

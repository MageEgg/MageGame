library ItemAttackUnitChallenge uses DamageCode,ItemGameFunc
    ...
    function InitAttackUnitChallengeState()
        ...
        InitAttackUnitChallengeCombatData(2,0,520,3300,14000,32000,62000,110000,190000,360000,620000,820000,1300000,1800000)
        InitAttackUnitChallengeCombatData(3,0,760,4800,20000,47000,90000,160000,280000,520000,900000,1200000,1900000,2600000)
        InitAttackUnitChallengeCombatData(4,0,1100,6900,29000,67000,140000,230000,410000,760000,1400000,1800000,2800000,3800000)
        InitAttackUnitChallengeCombatData(5,0,1600,9500,40000,93000,180000,320000,560000,1100000,1800000,2400000,3800000,5200000)
        InitAttackUnitChallengeCombatData(6,0,2100,13000,55000,130000,250000,430000,760000,1500000,2500000,3300000,5200000,7100000)
        InitAttackUnitChallengeCombatData(7,0,2700,17000,71000,170000,320000,560000,990000,1900000,3200000,4300000,6700000,9300000)
        //武灵
        InitAttackUnitChallengeCombatData(1,50,2400,13000,35000,74000,150000,310000,560000,870000,1400000,2000000,0,0)
        InitAttackUnitChallengeCombatData(2,50,3600,20000,53000,110000,220000,470000,830000,1300000,2100000,3000000,0,0)
        InitAttackUnitChallengeCombatData(3,50,5300,29000,77000,170000,320000,690000,1300000,1900000,3100000,4400000,0,0)
        InitAttackUnitChallengeCombatData(4,50,7700,42000,120000,240000,470000,1000000,1800000,2800000,4400000,6300000,0,0)
        InitAttackUnitChallengeCombatData(5,50,11000,57000,160000,330000,640000,1400000,2500000,3800000,6100000,8700000,0,0)
        InitAttackUnitChallengeCombatData(6,50,15000,77000,210000,440000,870000,1900000,3400000,5200000,8300000,12000000,0,0)
        InitAttackUnitChallengeCombatData(7,50,19000,100000,280000,580000,1200000,2500000,4400000,6800000,11000000,16000000,0,0)
        //符印
        InitAttackUnitChallengeCombatData(1,150,230,2000,6500,16000,28000,48000,81000,170000,0,0,0,0)
        InitAttackUnitChallengeCombatData(2,150,340,2900,9800,23000,42000,72000,130000,250000,0,0,0,0)
        InitAttackUnitChallengeCombatData(3,150,490,4300,15000,34000,62000,110000,180000,370000,0,0,0,0)
        InitAttackUnitChallengeCombatData(4,150,720,6200,21000,49000,89000,160000,260000,530000,0,0,0,0)
        InitAttackUnitChallengeCombatData(5,150,990,8500,29000,67000,130000,220000,360000,730000,0,0,0,0)
        InitAttackUnitChallengeCombatData(6,150,1400,12000,39000,91000,170000,290000,490000,990000,0,0,0,0)
        InitAttackUnitChallengeCombatData(7,150,1800,15000,51000,120000,220000,380000,640000,1300000,0,0,0,0)

        //境界
        InitAttackUnitChallengeCombatData(1,250,430,3400,13000,25000,83000,160000,330000,560000,840000,1400000,0,0)
        InitAttackUnitChallengeCombatData(2,250,650,5100,20000,37000,130000,240000,490000,830000,1300000,2000000,0,0)
        InitAttackUnitChallengeCombatData(3,250,950,7400,29000,54000,190000,350000,720000,1300000,1900000,2900000,0,0)
        InitAttackUnitChallengeCombatData(4,250,1400,11000,42000,79000,270000,510000,1100000,1800000,2700000,4200000,0,0)
        InitAttackUnitChallengeCombatData(5,250,1900,15000,57000,110000,370000,700000,1500000,2500000,3700000,5800000,0,0)
        InitAttackUnitChallengeCombatData(6,250,2600,21000,77000,150000,500000,950000,2000000,3400000,5100000,7900000,0,0)
        InitAttackUnitChallengeCombatData(7,250,3400,27000,100000,200000,650000,1300000,2600000,4400000,6600000,11000000,0,0)

        //挑战0
        InitAttackUnitChallengeCombatData(1,300,130,230,430,660,4200,7300,12000,18000,0,0,0,0)
        InitAttackUnitChallengeCombatData(2,300,200,340,640,980,6300,11000,18000,26000,0,0,0,0)
        InitAttackUnitChallengeCombatData(3,300,290,490,940,1500,9200,16000,26000,38000,0,0,0,0)
        InitAttackUnitChallengeCombatData(4,300,420,720,1400,2100,14000,24000,38000,56000,0,0,0,0)
        InitAttackUnitChallengeCombatData(5,300,580,990,1900,2900,19000,32000,52000,76000,0,0,0,0)
        InitAttackUnitChallengeCombatData(6,300,780,1400,2600,4000,25000,44000,71000,110000,0,0,0,0)
        InitAttackUnitChallengeCombatData(7,300,1100,1800,3400,5100,33000,57000,92000,140000,0,0,0,0)
        //挑战1
        InitAttackUnitChallengeCombatData(1,310,27000,45000,67000,98000,150000,270000,420000,550000,0,0,0,0)
        InitAttackUnitChallengeCombatData(2,310,40000,68000,100000,150000,220000,400000,630000,820000,0,0,0,0)
        InitAttackUnitChallengeCombatData(3,310,59000,99000,150000,220000,320000,580000,920000,1200000,0,0,0,0)
        InitAttackUnitChallengeCombatData(4,310,85000,150000,220000,320000,470000,840000,1400000,1800000,0,0,0,0)
        InitAttackUnitChallengeCombatData(5,310,120000,200000,300000,430000,640000,1200000,1900000,2400000,0,0,0,0)
        InitAttackUnitChallengeCombatData(6,310,160000,270000,400000,590000,870000,1600000,2600000,3300000,0,0,0,0)
        InitAttackUnitChallengeCombatData(7,310,210000,350000,520000,760000,1200000,2100000,3300000,4300000,0,0,0,0)

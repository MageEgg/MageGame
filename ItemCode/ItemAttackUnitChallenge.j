library ItemAttackUnitChallenge uses DamageCode,ItemGameFunc
    ...
    function InitAttackUnitChallengeState()
        ...
        */
        ...
        InitAttackUnitChallengeStateData(260,0,0,15,0,0,Buy_Unit,'AT6A',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")
        InitAttackUnitChallengeStateData(260,1,0,15,0,0,Buy_Unit,'AT6B',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")
        InitAttackUnitChallengeStateData(260,2,0,15,0,0,Buy_Unit,'AT6C',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")
        ...
        InitAttackUnitChallengeStateData(260,5,0,15,0,0,Buy_Unit,'AT6F',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")
        InitAttackUnitChallengeStateData(260,6,0,15,0,0,Buy_Unit,'AT6G',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")
        InitAttackUnitChallengeStateData(260,7,0,15,0,0,Buy_Unit,'AT6H',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")
        InitAttackUnitChallengeStateData(260,8,0,15,0,0,Buy_Unit,'AT6I',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")
        InitAttackUnitChallengeStateData(260,9,0,15,0,0,Buy_Unit,'AT6J',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")

        InitAttackUnitChallengeStateData(270,0,0,25,0,0,Buy_Unit,'AT7A',1,0,0,"|Cffffc926|n挑战奖励：|r|n随机宝物|n宝物槽|n攻击&业力&生命+30%")
        InitAttackUnitChallengeStateData(270,1,0,25,0,0,Buy_Unit,'AT7B',1,0,0,"|Cffffc926|n挑战奖励：|r|n随机宝物|n宝物槽|n攻击&业力&生命+30%")
        InitAttackUnitChallengeStateData(270,2,0,25,0,0,Buy_Unit,'AT7C',1,0,0,"|Cffffc926|n挑战奖励：|r|n随机宝物|n宝物槽|n攻击&业力&生命+30%")
        InitAttackUnitChallengeStateData(270,3,0,25,0,0,Buy_Unit,'AT7D',1,0,0,"|Cffffc926|n挑战奖励：|r|n随机宝物|n宝物槽|n攻击&业力&生命+30%")

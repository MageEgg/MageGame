library ItemAttackUnitChallenge uses DamageCode,ItemGameFunc
    ...
    function InitAttackUnitChallengeState()
        ...
        */
        ...
        //山灵
        InitAttackUnitChallengeCombatData(1,0,240,2300,6800,13000,26000,48000,80000,140000,210000,250000,420000,590000)
        InitAttackUnitChallengeCombatData(2,0,290,2900,8500,16000,33000,60000,99000,170000,260000,310000,520000,740000)
        InitAttackUnitChallengeCombatData(3,0,440,4300,13000,24000,49000,89000,150000,250000,380000,470000,780000,1200000)
        InitAttackUnitChallengeCombatData(4,0,640,6300,19000,36000,71000,130000,220000,360000,560000,690000,1200000,1700000)
        InitAttackUnitChallengeCombatData(5,0,930,9100,28000,52000,110000,190000,320000,530000,810000,1000000,1700000,2400000)
        InitAttackUnitChallengeCombatData(6,0,1300,13000,38000,71000,150000,260000,440000,720000,1200000,1400000,2300000,3300000)
        InitAttackUnitChallengeCombatData(7,0,1800,17000,51000,96000,200000,360000,600000,990000,1600000,1900000,3100000,4500000)
        //武灵
        InitAttackUnitChallengeCombatData(1,50,1700,7500,17000,39000,74000,140000,220000,330000,550000,880000,0,0)
        InitAttackUnitChallengeCombatData(2,50,2100,9400,22000,48000,93000,180000,270000,410000,680000,1100000,0,0)
        InitAttackUnitChallengeCombatData(3,50,3200,14000,32000,72000,140000,260000,400000,610000,1100000,1700000,0,0)
        InitAttackUnitChallengeCombatData(4,50,4700,21000,47000,110000,210000,380000,580000,890000,1500000,2500000,0,0)
        InitAttackUnitChallengeCombatData(5,50,6700,30000,68000,160000,300000,550000,850000,1300000,2200000,3600000,0,0)
        InitAttackUnitChallengeCombatData(6,50,9300,42000,93000,210000,410000,750000,1200000,1800000,3000000,4900000,0,0)
        InitAttackUnitChallengeCombatData(7,50,13000,56000,130000,290000,560000,1100000,1600000,2500000,4100000,6600000,0,0)
        //符印
        InitAttackUnitChallengeCombatData(1,150,57000,130000,220000,460000,400000,610000,970000,1200000,0,0,0,0)
        InitAttackUnitChallengeCombatData(2,150,71000,160000,270000,580000,490000,760000,1300000,1500000,0,0,0,0)
        InitAttackUnitChallengeCombatData(3,150,110000,230000,400000,870000,740000,1200000,1900000,2300000,0,0,0,0)
        InitAttackUnitChallengeCombatData(4,150,160000,340000,590000,1300000,1100000,1700000,2700000,3300000,0,0,0,0)
        InitAttackUnitChallengeCombatData(5,150,230000,490000,860000,1900000,1600000,2500000,3900000,4800000,0,0,0,0)
        InitAttackUnitChallengeCombatData(6,150,310000,670000,1200000,2600000,2200000,3400000,5300000,6600000,0,0,0,0)
        InitAttackUnitChallengeCombatData(7,150,430000,910000,1600000,3500000,3000000,4600000,7300000,9000000,0,0,0,0)

        //境界
        InitAttackUnitChallengeCombatData(1,250,240,1900,7500,13000,44000,85000,160000,460000,740000,1100000,0,0)
        InitAttackUnitChallengeCombatData(2,250,290,2400,9400,16000,55000,110000,200000,580000,920000,1400000,0,0)
        InitAttackUnitChallengeCombatData(3,250,440,3500,14000,23000,82000,160000,300000,870000,1400000,2100000,0,0)
        InitAttackUnitChallengeCombatData(4,250,640,5100,21000,34000,120000,240000,440000,1300000,2100000,3100000,0,0)
        InitAttackUnitChallengeCombatData(5,250,930,7500,30000,49000,180000,340000,640000,1900000,3000000,4400000,0,0)
        InitAttackUnitChallengeCombatData(6,250,1300,11000,42000,67000,240000,470000,880000,2600000,4100000,6100000,0,0)
        InitAttackUnitChallengeCombatData(7,250,1800,14000,56000,92000,330000,640000,1200000,3500000,5500000,8300000,0,0)

        //挑战0
        InitAttackUnitChallengeCombatData(1,300,36,140,300,500,3400,5700,8300,12000,0,0,0,0)
        InitAttackUnitChallengeCombatData(2,300,45,180,380,620,4300,7100,11000,14000,0,0,0,0)
        InitAttackUnitChallengeCombatData(3,300,68,270,560,930,6400,11000,16000,21000,0,0,0,0)
        InitAttackUnitChallengeCombatData(4,300,100,390,820,1400,9400,16000,23000,31000,0,0,0,0)
        InitAttackUnitChallengeCombatData(5,300,150,560,1200,2000,14000,23000,33000,45000,0,0,0,0)
        InitAttackUnitChallengeCombatData(6,300,210,770,1700,2800,19000,31000,46000,61000,0,0,0,0)
        InitAttackUnitChallengeCombatData(7,300,280,1100,2300,3800,26000,43000,62000,83000,0,0,0,0)
        //挑战1
        InitAttackUnitChallengeCombatData(1,310,16000,29000,44000,64000,88000,150000,210000,250000,0,0,0,0)
        InitAttackUnitChallengeCombatData(2,310,20000,36000,55000,80000,110000,180000,260000,310000,0,0,0,0)
        InitAttackUnitChallengeCombatData(3,310,30000,54000,82000,120000,170000,270000,380000,470000,0,0,0,0)
        InitAttackUnitChallengeCombatData(4,310,44000,79000,120000,180000,250000,390000,560000,690000,0,0,0,0)
        InitAttackUnitChallengeCombatData(5,310,64000,120000,180000,260000,360000,570000,820000,1000000,0,0,0,0)
        InitAttackUnitChallengeCombatData(6,310,88000,160000,240000,360000,490000,780000,1200000,1400000,0,0,0,0)
        InitAttackUnitChallengeCombatData(7,310,120000,220000,330000,480000,660000,1100000,1600000,1900000,0,0,0,0)

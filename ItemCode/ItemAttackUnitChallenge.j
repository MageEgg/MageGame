library ItemAttackUnitChallenge uses DamageCode,ItemGameFunc
    ...
    function InitAttackUnitChallengeState()
        ...
        */
        ...
        InitAttackUnitChallengeStateData(260,0,0,5,0,0,Buy_Unit,'AT6A',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")
        InitAttackUnitChallengeStateData(260,1,0,10,0,0,Buy_Unit,'AT6B',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")
        InitAttackUnitChallengeStateData(260,2,0,10,0,0,Buy_Unit,'AT6C',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")
        InitAttackUnitChallengeStateData(260,3,0,15,0,0,Buy_Unit,'AT6D',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")
        InitAttackUnitChallengeStateData(260,4,0,15,0,0,Buy_Unit,'AT6E',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")
        InitAttackUnitChallengeStateData(260,5,0,20,0,0,Buy_Unit,'AT6F',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")
        InitAttackUnitChallengeStateData(260,6,0,20,0,0,Buy_Unit,'AT6G',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")
        InitAttackUnitChallengeStateData(260,7,0,25,0,0,Buy_Unit,'AT6H',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")
        InitAttackUnitChallengeStateData(260,8,0,25,0,0,Buy_Unit,'AT6I',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")
        InitAttackUnitChallengeStateData(260,9,0,25,0,0,Buy_Unit,'AT6J',1,0,0,"|Cffffc926|n挑战奖励：|r|n境界突破1级|n随机道果|n|n|Cffbbbbbb拼脸是不可能拼脸的，只有存多点经验才能打高级点的道果这样紫。|r")

        InitAttackUnitChallengeStateData(270,0,0,5,0,0,Buy_Unit,'AT7A',1,0,0,"|Cffffc926|n挑战奖励：|r|n随机宝物|n宝物槽|n攻击&业力&生命+30%")
        InitAttackUnitChallengeStateData(270,1,0,10,0,0,Buy_Unit,'AT7B',1,0,0,"|Cffffc926|n挑战奖励：|r|n随机宝物|n宝物槽|n攻击&业力&生命+30%")
        InitAttackUnitChallengeStateData(270,2,0,15,0,0,Buy_Unit,'AT7C',1,0,0,"|Cffffc926|n挑战奖励：|r|n随机宝物|n宝物槽|n攻击&业力&生命+30%")
        InitAttackUnitChallengeStateData(270,3,0,20,0,0,Buy_Unit,'AT7D',1,0,0,"|Cffffc926|n挑战奖励：|r|n随机宝物|n宝物槽|n攻击&业力&生命+30%")
        InitAttackUnitChallengeStateData(270,4,0,25,0,0,Buy_Unit,'AT7E',1,0,0,"|Cffffc926|n挑战奖励：|r|n随机宝物|n宝物槽|n攻击&业力&生命+30%")
        InitAttackUnitChallengeStateData(270,5,0,30,0,0,Buy_Unit,'AT7F',1,0,0,"|Cffffc926|n挑战奖励：|r|n随机宝物|n宝物槽|n攻击&业力&生命+30%")

        InitAttackUnitChallengeStateData(280,0,3000,5,0,0,Buy_Unit,'AT8A',1,0,0,"|Cffffc926|n挑战奖励：|r|n金币加成+20%|n怪物攻击&生命+30%|n|n|Cffbbbbbb钱是会多不少，但后果自负噢。。|r")
        InitAttackUnitChallengeStateData(280,1,3000,10,0,0,Buy_Unit,'AT8B',1,0,0,"|Cffffc926|n挑战奖励：|r|n金币加成+20%|n怪物攻击&生命+30%|n|n|Cffbbbbbb钱是会多不少，但后果自负噢。。|r")
        InitAttackUnitChallengeStateData(280,2,5000,10,0,0,Buy_Unit,'AT8C',1,0,0,"|Cffffc926|n挑战奖励：|r|n金币加成+20%|n怪物攻击&生命+30%|n|n|Cffbbbbbb钱是会多不少，但后果自负噢。。|r")
        InitAttackUnitChallengeStateData(280,3,7000,15,0,0,Buy_Unit,'AT8D',1,0,0,"|Cffffc926|n挑战奖励：|r|n金币加成+20%|n怪物攻击&生命+30%|n|n|Cffbbbbbb钱是会多不少，但后果自负噢。。|r")
        InitAttackUnitChallengeStateData(280,4,10000,15,0,0,Buy_Unit,'AT8E',1,0,0,"|Cffffc926|n挑战奖励：|r|n金币加成+20%|n怪物攻击&生命+30%|n|n|Cffbbbbbb钱是会多不少，但后果自负噢。。|r")
        InitAttackUnitChallengeStateData(280,5,15000,20,0,0,Buy_Unit,'AT8F',1,0,0,"|Cffffc926|n挑战奖励：|r|n金币加成+20%|n怪物攻击&生命+30%|n|n|Cffbbbbbb钱是会多不少，但后果自负噢。。|r")
        InitAttackUnitChallengeStateData(280,6,20000,20,0,0,Buy_Unit,'AT8G',1,0,0,"|Cffffc926|n挑战奖励：|r|n金币加成+20%|n怪物攻击&生命+30%|n|n|Cffbbbbbb钱是会多不少，但后果自负噢。。|r")
        InitAttackUnitChallengeStateData(280,7,25000,25,0,0,Buy_Unit,'AT8H',1,0,0,"|Cffffc926|n挑战奖励：|r|n金币加成+20%|n怪物攻击&生命+30%|n|n|Cffbbbbbb钱是会多不少，但后果自负噢。。|r")
        InitAttackUnitChallengeStateData(280,8,30000,25,0,0,Buy_Unit,'AT8I',1,0,0,"|Cffffc926|n挑战奖励：|r|n金币加成+20%|n怪物攻击&生命+30%|n|n|Cffbbbbbb钱是会多不少，但后果自负噢。。|r")
        InitAttackUnitChallengeStateData(280,9,50000,30,0,0,Buy_Unit,'AT8J',1,0,0,"|Cffffc926|n挑战奖励：|r|n金币加成+20%|n怪物攻击&生命+30%|n|n|Cffbbbbbb钱是会多不少，但后果自负噢。。|r")

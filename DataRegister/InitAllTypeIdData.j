scope AllTypeIdData initializer init
    ...
    //输出代码
        ...
        call InitTypeIdStrings('FB23',"|CffFFD24D落魂钟|r","ReplaceableTextures\\CommandButtons\\BTNFB23.BLP","攻击暴击时，10%几率造成400码范围的750%业力的群体伤害。每8秒只能触发1次")
        ...
        call InitTypeIdStrings('FB39',"|CffFFD24D七宝妙树|r","ReplaceableTextures\\CommandButtons\\BTNFB39.BLP","每击杀1个单位，下一次攻击的伤害增加50%，此效果最多持续5秒且不会叠加")
        ...
        call InitTypeIdStrings('FB46',"|CffBF00FF青牛|r","ReplaceableTextures\\CommandButtons\\BTNFB46.BLP","攻击有4%几率，造成目标及周围400码 业力*500%的伤害")

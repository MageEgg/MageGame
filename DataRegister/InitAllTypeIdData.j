...
//输出代码
        ...
        call InitTypeIdStrings('FY01',"金之符印","war3mapImported\\UI_Fuin_01.tga","触发致命一击时，攻击速度提高|Cffffc9267%*金之符印数量|r，持续3秒，冷却5秒。")
        call InitTypeIdStrings('FY02',"木之符印","war3mapImported\\UI_Fuin_02.tga","最大生命值提高|Cffffc9264%*木之符印数量|r。")
        call InitTypeIdStrings('FY03',"水之符印","war3mapImported\\UI_Fuin_03.tga","道兵伤害提高|Cffffc9265%*水之符印数量|r")
        call InitTypeIdStrings('FY04',"火之符印","war3mapImported\\UI_Fuin_04.tga","释放主动技能时，攻击速度提高|Cffffc9267%*火之符印数量|r，持续3秒")
        call InitTypeIdStrings('FY05',"土之符印","war3mapImported\\UI_Fuin_05.tga","使用技能为自身施加护盾，抵挡伤害量为|Cffffc926最大生命值2.5%*土之符印|r数量，持续4秒。")
        call InitTypeIdStrings('FY06',"光之符印","war3mapImported\\UI_Fuin_06.tga","|CffFFC9265%*光之符印数量|r概率额外释放一次技能")
        call InitTypeIdStrings('FY07',"雷之符印","war3mapImported\\UI_Fuin_07.tga","攻击恢复|Cffffc9261%*雷之符印数量|r的已损失生命值")
        call InitTypeIdStrings('FY08',"暗之符印","war3mapImported\\UI_Fuin_08.tga","使用主动技能时，攻击力提高|Cffffc9264%*暗之符印数量|r，持续4秒")
        ...
        call InitTypeIdStrings('RY4D',"金鼠送福","ReplaceableTextures\\CommandButtons\\BTNRY4D.BLP","每秒金币+188\n开局金币+28888\n伤害减免+30%\n伤害加成+50%\n开局获得招魂旛Lv5一个")
    ...
    function InitDataString2()//注册法宝说明数据
        ...
        InitTypeIdJbStateOnec('FY04',"火神：攻击32次重置主动技能冷却","火神触发要求降低至攻击20次。","对R技能不生效。")
        InitTypeIdJbStateOnec('FY05',"每次受到攻击视为2次被攻击计数","对Boss造成的伤害增加25%","")
        InitTypeIdJbStateOnec('FY06',"额外释放技能概率+20%","额外释放技能次数+1","")
        InitTypeIdJbStateOnec('FY07',"攻击命中后立即追加三次普通攻击。冷却2秒","对生命低于35%的单位造成额外50%伤害","")
        InitTypeIdJbStateOnec('FY08',"暗裔：释放主动技能25%几率不进入冷却","暗裔触发几率提升至50%","对R技能不生效。")
    ...
    function InitDataInt2()
        ...
        InitEquipData('E022',0,0,35000,45,0,'E023',0,0)
        InitEquipData('E023',0,0,35000,40,0,'E024',0,0)
        InitEquipData('E024',0,0,35000,35,0,'E025',0,0)
        ...
        InitEquipData('E110',250,0,0,50,0,'E111',0,0)
        ...
        InitEquipData('E115',400,0,0,50,0,'E116',0,0)
        ...
        InitEquipData('E120',600,0,0,50,0,'E121',0,0)
        InitEquipData('E121',900,0,0,50,0,'E122',0,0)
        InitEquipData('E122',900,0,0,50,0,'E123',0,0)
        InitEquipData('E123',900,0,0,50,0,'E124',0,0)
        InitEquipData('E124',900,0,0,50,0,'E125',0,0)
        ...
        InitEquipData('E222',0,0,35000,45,0,'E223',0,0)
        InitEquipData('E223',0,0,35000,40,0,'E224',0,0)
        InitEquipData('E224',0,0,35000,35,0,'E225',0,0)

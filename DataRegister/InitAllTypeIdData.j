...
//输出代码
        ...
        call InitTypeIdStrings('RDAA',"果然暴君","ReplaceableTextures\\CommandButtons\\BTNCD01.blp","每秒金币+3")
        call InitTypeIdStrings('RDAB',"我真的知错了","ReplaceableTextures\\CommandButtons\\BTNCD02.blp","每秒攻击+2")
        call InitTypeIdStrings('RDAC',"老婆别打了","ReplaceableTextures\\CommandButtons\\BTNCD03.blp","每秒生命+50")
        call InitTypeIdStrings('RDAD',"家暴","ReplaceableTextures\\CommandButtons\\BTNCD04.blp","攻击+1%")
        call InitTypeIdStrings('RDAE',"我救我自己","ReplaceableTextures\\CommandButtons\\BTNCD05.blp","生命+1%")
        call InitTypeIdStrings('RDAF',"我也护犊子","ReplaceableTextures\\CommandButtons\\BTNCD06.blp","每秒攻击+2")
        call InitTypeIdStrings('RDAG',"爸，我回来了","ReplaceableTextures\\CommandButtons\\BTNCD07.blp","每秒攻击+2")
        call InitTypeIdStrings('RDAH',"太欧了！","ReplaceableTextures\\CommandButtons\\BTNCD08.blp","每秒攻击+2")
        call InitTypeIdStrings('RDAI',"护犊子","ReplaceableTextures\\CommandButtons\\BTNCD09.blp","每秒攻击+2")
        call InitTypeIdStrings('RDAJ',"真假....猴精..","ReplaceableTextures\\CommandButtons\\BTNCD10.blp","暴伤+5%")
        call InitTypeIdStrings('RDAK',"穿越回来还打你！","ReplaceableTextures\\CommandButtons\\BTNCD11.blp","每秒攻击+2")
        call InitTypeIdStrings('RDAL',"抓了再救","ReplaceableTextures\\CommandButtons\\BTNCD12.blp","每秒生命+50")
        call InitTypeIdStrings('RDAM',"我自己来","ReplaceableTextures\\CommandButtons\\BTNCD13.blp","每秒攻击+2")
        call InitTypeIdStrings('RDAN',"报仇雪恨","ReplaceableTextures\\CommandButtons\\BTNCD14.blp","每秒业力+2")
        call InitTypeIdStrings('RDAO',"悬壶济世","ReplaceableTextures\\CommandButtons\\BTNCD15.blp","每秒业力+2")
        call InitTypeIdStrings('RDAP',"销售精英","ReplaceableTextures\\CommandButtons\\BTNCD16.blp","抽奖概率+1.25%")
        call InitTypeIdStrings('RDAQ',"红颜祸水","ReplaceableTextures\\CommandButtons\\BTNCD17.blp","每秒生命+50")
        call InitTypeIdStrings('RDAR',"今晚的月亮好圆啊","ReplaceableTextures\\CommandButtons\\BTNCD18.blp","暴击+0.5%")
        call InitTypeIdStrings('RDAS',"自己人也打？","ReplaceableTextures\\CommandButtons\\BTNCD19.blp","每秒生命+50")
        call InitTypeIdStrings('RDAT',"师弟，你不行","ReplaceableTextures\\CommandButtons\\BTNCD20.blp","每秒攻击+2")
        call InitTypeIdStrings('RDAU',"师弟，你真不行","ReplaceableTextures\\CommandButtons\\BTNCD21.blp","复活时间-1秒")
        call InitTypeIdStrings('RDAV',"姐妹情深","ReplaceableTextures\\CommandButtons\\BTNCD22.blp","每秒攻击+10")
        call InitTypeIdStrings('RDAW',"打自己人怎么了？","ReplaceableTextures\\CommandButtons\\BTNCD23.blp","每秒生命+50")
        call InitTypeIdStrings('RDAX',"龙王出来喷水","ReplaceableTextures\\CommandButtons\\BTNCD24.blp","攻击+1%")
        call InitTypeIdStrings('RDAY',"今天爆率真高啊","ReplaceableTextures\\CommandButtons\\BTNCD25.blp","抽奖概率+1.25%")

...
call InitAbilityData('S004',1,1,0,0,0,0,0,0,"无情","致命概率|Cffff8000+5%|r，致命倍数|Cffff8000+600%|r\n\n|Cff00ff7f致命一击仅能通过普攻触发，与暴击效果叠加。|r","ReplaceableTextures\\CommandButtons\\BTNS004.blp")
call InitAbilityData('S005',1,1,0,1,0.2,0,0,0,"横扫千军","","ReplaceableTextures\\CommandButtons\\BTNS005.blp")
call InitAbilityData('S006',8,1,1,10,0,0,1,6,"无影杀","对目标范围内每个怪物进行攻击，造成|Cffff8000攻击*2.5|r物理伤害，附带|Cffff8000普攻效果|r。","ReplaceableTextures\\CommandButtons\\BTNS006.blp")
call InitAbilityData('S009',1,1,0,0,0,0,0,2,"连击","攻击命中后立即|Cffff8000追加一次|r普通攻击","ReplaceableTextures\\CommandButtons\\BTNS009.blp")
...
call InitAbilityData('S019',1,1,0,1,0.2,0,0,0,"卸甲","","ReplaceableTextures\\CommandButtons\\BTNS019.blp")
...
call InitAbilityData('S027',1,1,1,13,0,0,1,0,"九天御雷击","攻击|Cffff800010%|r概率对目标范围造成|Cffff8000攻击*13|r物理伤害","ReplaceableTextures\\CommandButtons\\BTNS027.blp")
call InitAbilityData('S028',1,1,2,15,0,0,2,0,"冥月流星落","攻击|Cff00bfff10%|r概率对目标范围造成|Cff00bfff法强*15|r法术伤害","ReplaceableTextures\\CommandButtons\\BTNS028.blp")
...
call InitAbilityData('S030',1,1,99,10,0,0,1,0,"三昧真火","每|Cffff800010|r次攻击释放三昧真火，对敌方造成|Cffff8000攻击*10|r+|Cff00bfff法强*10|r物理伤害","ReplaceableTextures\\CommandButtons\\BTNS030.blp")
call InitAbilityData('S032',1,1,0,1,0.2,0,0,0,"血之沸腾","","ReplaceableTextures\\CommandButtons\\BTNS032.blp")
call InitAbilityData('S033',2,1,0,0,0,0,0,8,"斩意诀","|CffFF80006|r秒内增加|Cffff800050%|r攻击速度。\n\n|Cff00ff7f效果可叠加。|r","ReplaceableTextures\\CommandButtons\\BTNS033.blp")
call InitAbilityData('S034',1,1,0,0,0,0,0,0,"风扬阵","600码范围内所有玩家增加|Cffff800040%|r攻击速度","ReplaceableTextures\\CommandButtons\\BTNS034.blp")
call InitAbilityData('S035',1,1,2,8,0,0,2,0,"业火咒","每|Cff00bfff8|r次攻击施动业火咒术，对目标范围内造成|Cff00bfff法强*8|r法术伤害","ReplaceableTextures\\CommandButtons\\BTNS035.blp")
call InitAbilityData('S038',1,1,1,4,0,0,1,0,"罡风破","每|Cffff800012|r次攻击对目标范围造成|Cffff8000攻击*4|r物理伤害","ReplaceableTextures\\CommandButtons\\BTNS038.blp")
call InitAbilityData('S039',1,1,2,5,0,0,2,0,"他山之石","每|Cff00bfff12|r次攻击对目标范围造成|Cff00bfff法强*5|r法术伤害。","ReplaceableTextures\\CommandButtons\\BTNS039.blp")
call InitAbilityData('S040',1,1,2,4,0,0,2,0,"弱水咒","攻击|Cff00bfff10%|r概率对目标范围造成|Cff00bfff法强*4|r法术伤害","ReplaceableTextures\\CommandButtons\\BTNS040.blp")
call InitAbilityData('S046',2,1,2,3,0,0,2,6,"引爆","对自身范围内敌人造成|Cff00bfff法强*4*中毒叠加次数|r法术伤害","ReplaceableTextures\\CommandButtons\\BTNS046.blp")
call InitAbilityData('S047',2,1,2,0.75,0,0,2,16,"毒体","开启后使周围地方单位进入|Cff00ff7f中毒状态|r，每秒造成|Cff00bfff法强*0.75|r法术伤害。\n\n|Cff00ff7f持续伤害最多可叠加8次。|r","ReplaceableTextures\\CommandButtons\\BTNS047.blp")
call InitAbilityData('S048',1,1,2,5,0,0,2,0,"狐媚术","攻击|Cff00bfff12.5%|r概率对目标范围施加一次|Cffff80c0魅惑|r，造成|Cff00bfff法强*5|r法术伤害，|Cff00bfff8|r秒内降低|Cff00bfff6%|r攻速及移动速度。\n\n|Cff00ff7f减速效果可叠加，上限8次|r","ReplaceableTextures\\CommandButtons\\BTNS048.blp")
call InitAbilityData('S049',2,1,2,4,0,0,2,8,"失心令","对周围敌人造成|Cff00bfff法强*4*魅惑层数|r法术伤害","ReplaceableTextures\\CommandButtons\\BTNS049.blp")
...
call InitAbilityData('S053',2,1,2,2,0,0,2,2,"落魂咒","对周围单位造成|Cff00bfff法强*8|r法术伤害，|Cff00bfff20%|r几率造成|Cff00bfff双倍|r伤害\n\n|Cff00ff7f固定冷却时间|r","ReplaceableTextures\\CommandButtons\\BTNS053.blp")
call InitAbilityData('S056',1,1,0,0,0,0,0,0,"术神式","攻击|Cff00bfff3%|r重置所有技能冷却时间。\n\n|Cff00ff7f概率不受天命影响。|r","ReplaceableTextures\\CommandButtons\\BTNS056.blp")
call InitAbilityData('S057',1,1,0,0,0,0,0,0,"灵犀式","攻击|Cff00bfff24次|r重置所有技能冷却","ReplaceableTextures\\CommandButtons\\BTNS057.blp")
call InitAbilityData('S058',1,1,0,1,0.2,0,0,0,"仙之心","","ReplaceableTextures\\CommandButtons\\BTNS058.blp")
...
call InitAbilityData('S062',1,1,0,0,0,0,0,0,"帝命","|Cff00FF7F帝星或将星|r触发时，额外|Cff00bfff释放技能次数+2|r。","ReplaceableTextures\\CommandButtons\\BTNS062.blp")
...
call InitAbilityData('S066',1,1,0,1,0.2,0,0,0,"灭魂","","ReplaceableTextures\\CommandButtons\\BTNS066.blp")
call InitAbilityData('S070',3,1,1,3,0,0,1,20,"暴风剑雨","对目标范围内怪物造成|Cffff800014次|r攻击，每次攻击造成|Cffff8000攻击*2|r物理伤害。\n","ReplaceableTextures\\CommandButtons\\BTNS070.blp")
call InitAbilityData('S073',2,1,1,4,0,0,1,12,"混元珠","掷出|Cffff80004颗|r混元宝珠围绕自身旋转，每次碰撞到怪物时造成|Cffff8000攻击*4|r物理伤害，并|Cffffcc00眩晕0.5秒|r。\n对|Cff00ff7f失明状态|r的怪物造成|Cffff8000额外30%物理伤害|r。\n\n|Cff00ff7f技能结束时重置戮目珠的技能冷却。|r","ReplaceableTextures\\CommandButtons\\BTNS073.blp")
call InitAbilityData('S074',3,1,1,4.5,0,0,1,6,"戮目珠","对目标范围掷出戮目珠，对碰撞到的怪物造成|Cffff8000攻击*4.5|r物理伤害，并使其进入|Cff00ff7f失明状态|r，攻击命中率降低30%，持续3秒。","ReplaceableTextures\\CommandButtons\\BTNS074.blp")
...
call InitAbilityData('S076',1,1,1,5,0,0,1,0,"连环刺","攻击|Cffff800015%|r概率对目标范围造成|Cffff8000AD*5|r物理伤害。\n\n触发后2s内|Cffff0000夺命刺|r概率增加|Cffff800010%|r。","ReplaceableTextures\\CommandButtons\\BTNS076.blp")
...
call InitAbilityData('S080',3,1,1,2.5,0,0,1,8,"剑灵诛仙式","万剑出鞘，对目标范围造成|Cffff8000攻击*1.2|r物理伤害。\n\n|Cff00ff7f攻击越高，持续时间越长。|r","ReplaceableTextures\\CommandButtons\\BTNS080.blp")
call InitAbilityData('S081',3,1,2,2.5,0,0,2,8,"真空领域","将目标范围内的所有单位聚卷入中心，每|Cff00bfff0.5|r秒造成|Cff00bfff法强*2|r法术伤害。\n\n|Cff00ff7f法强越高，持续时间越长。|r","ReplaceableTextures\\CommandButtons\\BTNS081.blp")
call InitAbilityData('S082',2,1,1,2.5,0,0,1,8,"雷神之子","召唤4个雷球，每个雷球，雷球每|Cffff80000.75|r秒对800码内随机目标周围发起200码范围攻击，造成|Cffff8000攻击*2.5|r物理伤害。\n\n|Cff00bfff攻击越高，雷球持续时间越长。|r","ReplaceableTextures\\CommandButtons\\BTNS082.blp")
call InitAbilityData('S083',2,1,2,2.5,0,0,2,8,"十方飓风破","自身每|Cff00bfff0.75|r秒向周围逸散暴风，造成|Cff00bfff法强*2.5|r法术伤害。\n\n|Cff00ff7f法强越高，持续时间越长。|r","ReplaceableTextures\\CommandButtons\\BTNS083.blp")
call InitAbilityData('S087',2,1,0,0,0,0,0,7,"五行道兵","召唤1个五行道兵。道兵拥有多重箭，每次攻击伤害递增|Cffff800010%|r，上限|Cffff8000100%|r。\n|Cff00ff7f道兵攻击与人物法强有关|r\n\n|Cff00ff7f通灵秘术：|r|Cffcccccc10%概率触发一次额外攻击。|r","ReplaceableTextures\\CommandButtons\\BTNS087.blp")
call InitAbilityData('S088',1,1,0,0,0,0,0,0,"通灵契约","召唤物数量|Cffffcc00+2|r","ReplaceableTextures\\CommandButtons\\BTNS088.blp")
call InitAbilityData('S089',2,1,0,0,0,0,0,16,"天神道兵","召唤1个天神道兵。道兵每次攻击伤害递增|Cffff800010%|r，上限|Cffff8000100%|r。\n|Cff00ff7f道兵攻击与人物攻击和法强有关|r\n\n|Cff00ff7f通灵秘术：|r|Cffcccccc进化为混沌道兵，攻击力翻倍，每次攻击伤害递增20%，上限200%。|r","ReplaceableTextures\\CommandButtons\\BTNS089.blp")
call InitAbilityData('S090',2,1,0,0,0,0,2,10,"噬魂龙魄","召唤1个噬魂龙魄，使周围600码单位生机骤减，每0.5秒造成|Cff00bfff法强*1|r法术伤害。\n\n|Cff00ff7f多个噬魂灵魄伤害可叠加。|r","ReplaceableTextures\\CommandButtons\\BTNS090.blp")
...
call InitAbilityData('S098',1,1,1,6,0,0,1,0,"反震","被攻击|Cffffcc0010%|r概率对周围敌人造成|Cffffcc00生命值*6|r物理伤害","ReplaceableTextures\\CommandButtons\\BTNS098.blp")
call InitAbilityData('S099',1,1,0,1,0.2,0,0,0,"刚毅之心","","ReplaceableTextures\\CommandButtons\\BTNS099.blp")
call InitAbilityData('S101',3,1,1,8,0,0,1,8,"雷光破","对目标范围造成|Cffff8000攻击*8|r物理伤害，额外造成|Cffffcc00生命值*4|r物理伤害。","ReplaceableTextures\\CommandButtons\\BTNS101.blp")
call InitAbilityData('S102',1,1,5,3,0,0,2,0,"黑龙之灵","释放1条|Cff999999黑龙之灵|r，每秒对敌人造成|Cffffcc00生命值*1.2|r法术伤害。","ReplaceableTextures\\CommandButtons\\BTNS102.blp")
call InitAbilityData('S107',1,1,0,1,0.2,0,0,0,"鬼魅","","ReplaceableTextures\\CommandButtons\\BTNS107.blp")
call InitAbilityData('S110',7,1,1,3,0,0,1,10,"虚灵斩","对目标范围内怪物造成|Cffff80003次攻击|r，每次攻击造成|Cffff8000攻击*3|r物理伤害。\n\n|Cff00ff7f每30%攻速额外攻击1次。|r","ReplaceableTextures\\CommandButtons\\BTNS110.blp")
call InitAbilityData('S113',3,1,1,4,0,0,1,8,"紫金葫","投射一个紫金葫，沿途造成|Cffff8000攻击*4|r物理伤害。\n到达目标区域后爆炸，造成|Cff00bfff法强*4|r法术伤害\n\n|Cff00ff7f30%几率额外投射2个葫芦。|r","ReplaceableTextures\\CommandButtons\\BTNS113.blp")
call InitAbilityData('S116',2,1,2,3,0,0,2,8,"罪焰","自身周围随机点产生一次罪焰。\n罪焰每秒造成|Cff00bfff法强*3|r法术伤害，持续3秒","ReplaceableTextures\\CommandButtons\\BTNS116.blp")
call InitAbilityData('S117',1,1,2,3,0,0,2,0,"元气破","攻击|Cff00bfff15%|r几率对目标范围造成|Cff00bfff法强*4|r法术伤害，并回复|Cff00bfff10|r点蓝量","ReplaceableTextures\\CommandButtons\\BTNS117.blp")
call InitAbilityData('S118',1,1,0,1,0.2,0,0,0,"血脉之力","","ReplaceableTextures\\CommandButtons\\BTNS118.blp")
call InitAbilityData('S119',1,1,0,1,0.2,0,0,0,"嗜血","","ReplaceableTextures\\CommandButtons\\BTNS119.blp")
call InitAbilityData('S120',2,1,1,4,0,0,1,8,"撼地击","对自身周围造成|Cffff8000攻击*4|r物理伤害。\n\n|Cff00ff7f40%几率额外释放一次大范围撼地击。|r","ReplaceableTextures\\CommandButtons\\BTNS120.blp")
call InitAbilityData('S123',2,1,2,6,0,0,2,8,"冰暴术","自身周围每秒产生一次随机冰暴，造成|Cff00bfff法强*6|r法术。","ReplaceableTextures\\CommandButtons\\BTNS123.blp")
call InitAbilityData('S127',2,1,0,0,0,0,0,10,"回春术","|CffFFBF005|r秒内回复|Cffffcc0060%|r最大生命值\n\n|Cff00ff7f效果不可叠加|r","ReplaceableTextures\\CommandButtons\\BTNS127.blp")
call InitAbilityData('S128',1,1,0,0,0,0,0,0.3,"以战养战","|CffFFBF00闪避|r时回复|Cffffbf002%|r最大生命值。\n\n|Cff00ff7f内置冷却0.3秒|r","ReplaceableTextures\\CommandButtons\\BTNS128.blp")
call InitAbilityData('S129',1,1,0,0,0,0,0,0,"贪婪","杀敌金币|Cffffbf00+3|r","ReplaceableTextures\\CommandButtons\\BTNS129.blp")
...
call InitAbilityData('S234',5,0,2,18,0,0,2,20,"离魂秘术","对目标造成|Cff00bfff法强*18|r伤害，随后使目标周围单位无法攻击，|Cff00bfff承受法术伤害+80%|r，承受物理伤害-50%。","ReplaceableTextures\\CommandButtons\\BTNS234.blp")
...
call InitAbilityData('S501',2,0,1,2,0,0,1,12,"天罚连击","突刺至目标区域并挥砍|Cffff80003|r次，每次造成|Cffff8000攻击*2|r物理伤害。","ReplaceableTextures\\CommandButtons\\BTNS501_1.blp")
call InitAbilityData('S502',5,0,1,1.5,0,0,1,10,"土遁袭杀","钻入地底突进至目标身后进行|Cffff80002次|r爪击，每次造成|Cffff8000攻击*1.5|r伤害。","ReplaceableTextures\\CommandButtons\\BTNS502.blp")
call InitAbilityData('S503',1,0,99,3,0,0,2,6,"玉清合荒","若600码范围内，有敌/友军释放主动技能，你对自身周围造成|Cffffbf00（攻击+法强）*3|r法术伤害。","ReplaceableTextures\\CommandButtons\\BTNS503.blp")
...
call InitAbilityData('S507',1,0,0,0,0,0,0,0,"万物亲和","每|Cffffbf0010|r秒回复|Cffffbf0020%最大生命值","ReplaceableTextures\\CommandButtons\\BTNS507.blp")
call InitAbilityData('S508',1,0,2,8,0,0,2,0,"镜花之舞","攻击|Cff00bfff10%|r概率积累|Cff00bfff1|r层|Cff00bfff妖狐印记|r，达到|Cff00bfff7|r层时向周围释放|Cff00bfff镜花之舞|r。\n每层妖狐印记提高|Cff00bfff6%|r攻击速度，镜花之舞造成|Cff00bfff法强*8|r法术伤害。\n\n|Cff00ff7f概率受天命影响。","ReplaceableTextures\\CommandButtons\\BTNS508.blp")
...
call InitAbilityData('S512',2,0,1,3,0,0,1,12,"天王宝塔","掷出天王宝塔镇压目标，造成|Cffff8000攻击*3|r物理伤害并|Cffffbf00眩晕|r2秒。\n\n|Cff00ff7f暴击>30%|r：伤害翻倍。","ReplaceableTextures\\CommandButtons\\BTNS512.blp")
...
call InitAbilityData('S519',1,0,2,3,0,0,2,0,"天眼神光","|CffFFBF00攻击或施法|r时，|Cffffbf005%|r几率开启天眼发射神光，造成|Cffff8000法强*3|r法术伤害。","ReplaceableTextures\\CommandButtons\\BTNS519.blp")
...
call InitAbilityData('S525',2,0,1,1.5,0,0,1,8,"攒心钉","发射|Cffff80003枚|r攒心钉，造成|Cffff8000攻击*1.5|r物理伤害，4s内降低10护甲。\n\n|Cff00ff7f效果不可叠加。","ReplaceableTextures\\CommandButtons\\BTNS525.blp")
call InitAbilityData('S526',1,0,1,4,0,0,1,6,"当头棒击","每6秒攻击对直线范围造成|Cffff8000攻击*4|r物理伤害。","ReplaceableTextures\\CommandButtons\\BTNS526.blp")
...
call InitAbilityData('S529',1,0,0,0,0,0,0,20,"神医救世","队友或你死亡时，直接复活。","ReplaceableTextures\\CommandButtons\\BTNS529.blp")

...
call InitAbilityData('S052',1,5,2,7.5,8.5,9.5,11,12.5,2,0,1,"神火天降","每|Cffffc92616|r次攻击施动神火天降，对目标范围内敌人造成伤害。\n\n|Cff00ff7f命中时|r|Cffffc926所有技能冷却-0.5秒|r|Cff00ff7f。|r","ReplaceableTextures\\CommandButtons\\BTNS052.blp")
...
call InitAbilityData('S079',3,5,2,12,14,16,19,20,2,8,1,"龙神陨光","蓄力|Cffffd24d3秒|r后，对直线范围造成伤害。","ReplaceableTextures\\CommandButtons\\BTNS079.blp")

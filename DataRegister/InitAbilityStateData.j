...
call InitAbilityData('S501',3,0,1,2,0,0,1,12,"天罚连击","向前挥砍后突刺造成大量伤害。\n挥砍一段：造成2*攻击物理伤害。\n挥砍二段：造成2*攻击物理伤害。\n突刺：8%目标已损失生命伤害。","ReplaceableTextures\\CommandButtons\\BTNS501.blp")
...
call InitAbilityData('S503',1,0,99,1,0,0,2,0.2,"玉清合荒","突刺至目标位置并向前方连续挥击，每次挥击造成攻击*2物理伤害。\n\n暴击达到30%时，额外造成一次刺击，造成攻击*8物理伤害。","ReplaceableTextures\\CommandButtons\\BTNS503.blp")
call InitAbilityData('S504',3,0,1,2,0,0,1,10,"火尖枪舞","幻化6个无法移动的分身，每个分身拥有70%攻击力。\n4秒后分身爆炸，对周围400码造成4*法强法术伤害。","ReplaceableTextures\\CommandButtons\\BTNS504.blp")
call InitAbilityData('S505',2,0,2,4,0,0,1,12,"一气化三清","斩杀低于15%最大生命值的敌人。","ReplaceableTextures\\CommandButtons\\BTNS505.blp")
call InitAbilityData('S506',1,0,0,0,0,0,1,0,"斩仙飞刀","每5秒回复20%最大生命值\n\n物穿>30%:召唤物伤害+30%\n法穿>30%:召唤物数量+2","ReplaceableTextures\\CommandButtons\\BTNS506.blp")
call InitAbilityData('S507',1,0,0,0,0,0,1,0,"万物亲和","每次触发被动技能可积累1层妖狐印记，达到7层时向周围释放镜花之舞。\n每层妖狐印记提高10%攻击速度，镜花之舞造成法强*6法术伤害。","ReplaceableTextures\\CommandButtons\\BTNS507.blp")
call InitAbilityData('S508',1,0,2,6,0,0,1,0,"镜花之舞","奕剑之道，在于无招。\n普攻伤害+30%\n\n普攻伤害超过120%时，物理伤害+30%。","ReplaceableTextures\\CommandButtons\\BTNS508.blp")
call InitAbilityData('S509',1,0,0,0,0,0,1,0,"奕剑之道","使用后依次变幻形态，并获得相应加成：\n金龙形态：暴击+10%\n白虎形态：攻速+45%\n人形态：冷却-10%","ReplaceableTextures\\CommandButtons\\BTNS509.blp")
call InitAbilityData('S510',2,0,0,0,0,0,1,2,"八九玄功","释放普通技能有50%几率失败，但成功了将增加2%伤害加成，上限150%。","ReplaceableTextures\\CommandButtons\\BTNS510.blp")
call InitAbilityData('S511',1,0,0,0,0,0,1,0,"命途多舛","掷出天王宝塔镇压目标，增加与自身生命值/4攻击力。\n\n无法镇压Boss单位。","ReplaceableTextures\\CommandButtons\\BTNS511.blp")
call InitAbilityData('S512',4,0,0,0,0,0,1,120,"天王宝塔","使用毫毛在目标地点幻化一个法身，可重复施放你的技能，但只造成50%伤害。\n\n法身无法攻击，不可选取，不受攻击。","ReplaceableTextures\\CommandButtons\\BTNS512.blp")
call InitAbilityData('S513',3,0,0,0,0,0,1,12,"身外法身","钻入地底突进至目标身后进行2次爪击，每次造成攻击*2伤害。\n\n每提高100%攻击速度额外增加一次爪击。","ReplaceableTextures\\CommandButtons\\BTNS513.blp")
call InitAbilityData('S514',2,0,2,4,0,0,1,10,"冰封万里","对自身500码范围发动一次冰暴，造成法强*4法术伤害\n\n冷却缩减>30%：额外对自身800码发动一次冰暴，造成法强*6法术伤害。","ReplaceableTextures\\CommandButtons\\BTNS514.blp")
call InitAbilityData('S515',1,0,2,8,0,0,1,0,"日月珠","每次施法凝聚一颗日月珠环绕自身，数量达到8颗时，向攻击目标造成法强*8范围伤害。","ReplaceableTextures\\CommandButtons\\BTNS515.blp")
call InitAbilityData('S516',2,0,0,0,0,0,1,30,"悔悟","自裁悔过，所有人回复满额生命，提高15%伤害加成。\n\n悔过次数>30：增加自身当前攻击60%","ReplaceableTextures\\CommandButtons\\BTNS516.blp")
call InitAbilityData('S517',1,0,0,0,0,0,1,0,"天资聪颖","每次学习技能获得一定法强加成。","ReplaceableTextures\\CommandButtons\\BTNS517.blp")
call InitAbilityData('S518',1,0,0,0,0,0,1,0,"九转神功","每次突破境界时，50%几率获得额外12%突破属性收益","ReplaceableTextures\\CommandButtons\\BTNS518.blp")
call InitAbilityData('S519',1,0,2,2,0,0,1,0,"天眼神光","攻击10%几率或施法时，开启天眼向目标位置发射神光，造成法强*2法术伤害。","ReplaceableTextures\\CommandButtons\\BTNS519.blp")
call InitAbilityData('S520',1,0,0,0,0,0,1,0,"莲花化身","承受技能伤害减少50%，免疫技能负面效果。","ReplaceableTextures\\CommandButtons\\BTNS520.blp")
call InitAbilityData('S521',2,0,0,0,0,0,1,40,"中秋快乐","每次使用获得一个随机月饼。\n蛋黄月饼：回复80%生命，解除异常状态\n豆沙月饼：回复70%蓝量\n冰皮月饼：攻击速度+60%\n果蔬月饼：法术伤害提高40%\n鲜肉月饼\n物理伤害提高40%\n\n状态持续15秒。","ReplaceableTextures\\CommandButtons\\BTNS521.blp")
call InitAbilityData('S522',1,0,0,0,0,0,1,0,"风雷咒术","获得风雷咒术加持，攻击速度提高200%。过快的攻击速度导致物理伤害降低70%。","ReplaceableTextures\\CommandButtons\\BTNS522.blp")
call InitAbilityData('S523',4,0,0,0,0,0,1,12,"狐媚术","回复目标30%生命并解除所有负面效果，4s内提高10%攻击和法强。","ReplaceableTextures\\CommandButtons\\BTNS523.blp")
call InitAbilityData('S524',4,0,0,0,0,0,1,180,"道友请留步","劝说目标队友分享属性：\n30%成功，该队友和你攻击及法强提高20%。\n40%暴力劝说，获得该队友40%攻击及法强。\n30%失败，队友获得你40%攻击及法强\n劝说效果持续3分钟。\n\n该技能冷却时间固定。","ReplaceableTextures\\CommandButtons\\BTNS524.blp")
call InitAbilityData('S525',3,0,1,2,0,0,1,8,"攒心钉","对目标发射3枚攒心钉，造成攻击*2物理伤害，4s内降低15护甲。\n\n效果不可叠加。","ReplaceableTextures\\CommandButtons\\BTNS525.blp")
...
call InitAbilityData('S527',4,0,0,0,0,0,1,30,"昏庸无道","处决一名队友，额外获得其30%攻击。","ReplaceableTextures\\CommandButtons\\BTNS527.blp")
call InitAbilityData('S528',1,0,0,0,0,0,1,0,"尚武乏谋","有什么问题是暴力不能解决的呢？\n物理伤害+50%，法术伤害-100%","ReplaceableTextures\\CommandButtons\\BTNS528.blp")
call InitAbilityData('S529',1,0,0,0,0,0,1,15,"神医救世","队友或你死亡时，直接复活。","ReplaceableTextures\\CommandButtons\\BTNS529.blp")
call InitAbilityData('S530',1,0,0,0,0,0,1,0,"百发百中","攻击必定命中。","ReplaceableTextures\\CommandButtons\\BTNS530.blp")
call InitAbilityData('S531',1,0,0,0,0,0,1,0,"料事如神","每次占星挑战成功，增加一定法强。","ReplaceableTextures\\CommandButtons\\BTNS531.blp")

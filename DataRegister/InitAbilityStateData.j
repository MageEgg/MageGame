...
call InitAbilityData('S002',1,1,0,2,4,6,0,6,"夺天一击","每|Cffffc9266|r秒，攻击必定触发|Cffffc926致命一击|r","ReplaceableTextures\\CommandButtons\\BTNS002.blp")
call InitAbilityData('S003',1,1,0,0,0,0,0,0,"残暴","提高|Cffffc926致命倍数|r","ReplaceableTextures\\CommandButtons\\BTNS003.blp")
call InitAbilityData('S004',1,1,0,2,3,4,0,0,"无情","攻击|Cffffc9266%|r概率造成|Cffffc926致命一击|r","ReplaceableTextures\\CommandButtons\\BTNS004.blp")
call InitAbilityData('S005',1,1,0,0.25,0.4,0.55,0,0,"横扫千军","","ReplaceableTextures\\CommandButtons\\BTNS005.blp")
call InitAbilityData('S006',8,1,1,0.4,0.6,0.8,2,6,"无影杀","对目标范围内怪物进行5次攻击，附带|Cffffc926普攻效果|r。","ReplaceableTextures\\CommandButtons\\BTNS006.blp")
call InitAbilityData('S009',1,1,0,5,4,3,0,0,"连击","攻击命中后立即|Cffff8000追加一次|r普通攻击。|n|Cff00ff7f触发攻击特效|r","ReplaceableTextures\\CommandButtons\\BTNS009.blp")
call InitAbilityData('S018',2,1,1,0,0,3,2,8,"破甲阵","使用精湛的刀术对周围怪物造成伤害，并降低|Cffff800015%防御|r3秒。|n|Cff00ff7f效果不可叠加|r","ReplaceableTextures\\CommandButtons\\BTNS018.blp")
call InitAbilityData('S019',1,1,0,0,0.33,0.53,0,0,"卸甲","","ReplaceableTextures\\CommandButtons\\BTNS019.blp")
call InitAbilityData('S022',8,1,1,0,0,0,2,10,"强攻阵","火莲降世，对周围怪物造成伤害，3s内增加|Cffffc92610%|r暴击。\n\n|Cff00ff7f效果可叠加|r","ReplaceableTextures\\CommandButtons\\BTNS022.blp")
call InitAbilityData('S028',1,1,1,3,4,5,2,0,"冥月流星落","攻击|Cffffc9266%|r概率引动冥月流星，对目标范围造成伤害","ReplaceableTextures\\CommandButtons\\BTNS028.blp")
call InitAbilityData('S029',1,1,0,0,0.4,0.6,0,0,"天命","增加|Cffffc9265%|r技能触发概率。","ReplaceableTextures\\CommandButtons\\BTNS029.blp")
call InitAbilityData('S032',1,1,0,0.2,0.4,0.6,0,0,"血之沸腾","","ReplaceableTextures\\CommandButtons\\BTNS032.blp")
call InitAbilityData('S033',2,1,0,0,0,0.2,0,8,"斩意诀","|CffFFC9266|r秒内增加|Cffffc92640%|r攻击速度。|n|Cff00ff7f效果可叠加|r","ReplaceableTextures\\CommandButtons\\BTNS033.blp")
call InitAbilityData('S035',1,1,1,3,4,5,2,0,"业火咒","每|Cff00bfff10|r次攻击施动业火咒术，对目标范围内造成伤害","ReplaceableTextures\\CommandButtons\\BTNS035.blp")
call InitAbilityData('S048',1,1,1,4,6,8,2,0,"狐媚术","攻击|Cffffc9266%|r概率对目标范围造成魅惑状态及伤害，3秒内降低|Cffffc92620%|r攻速及移动速度。","ReplaceableTextures\\CommandButtons\\BTNS048.blp")
call InitAbilityData('S052',3,1,1,0,0,0,2,6,"神火天降","对目标范围内敌人造成伤害，所有技能|Cff00bfff冷却减少0.5秒|r。","ReplaceableTextures\\CommandButtons\\BTNS052.blp")
call InitAbilityData('S053',2,1,1,0,2,3,2,2,"落魂咒","对周围单位造成伤害，|Cff00bfff20%|r几率造成|Cff00bfff双倍|r伤害\n\n|Cff00ff7f固定冷却时间|r","ReplaceableTextures\\CommandButtons\\BTNS053.blp")
call InitAbilityData('S056',1,1,0,0,0,0.03,0,0,"术神式","攻击一定几率重置所有技能冷却时间。\n\n|Cff00ff7f概率不受天命影响。|r","ReplaceableTextures\\CommandButtons\\BTNS056.blp")
call InitAbilityData('S058',1,1,0,0,0.4,0.52,0,0,"仙之心","","ReplaceableTextures\\CommandButtons\\BTNS058.blp")
call InitAbilityData('S061',1,1,0,0,0,0.3,0,0,"帝星","一定概率|Cffffc926额外施法|r1次","ReplaceableTextures\\CommandButtons\\BTNS061.blp")
call InitAbilityData('S066',1,1,0,0,0.33,0.53,0,0,"灭魂","","ReplaceableTextures\\CommandButtons\\BTNS066.blp")
call InitAbilityData('S074',3,1,1,0,0.5,1,2,6,"戮目珠","对目标范围掷出戮目珠，对碰撞到的怪物造成伤害，并使其进入失明状态，攻击命中率降低30%，持续3秒。","ReplaceableTextures\\CommandButtons\\BTNS074.blp")
call InitAbilityData('S075',1,1,1,3,4,6,2,0,"夺命刺","攻击|Cffffc9266%|r概率对目标造成伤害，\n\n触发后追加一次|Cffffc926连环刺|r。|Cff00ff7f（需已学习连环刺）|r","ReplaceableTextures\\CommandButtons\\BTNS075.blp")
call InitAbilityData('S076',1,1,1,2,3,4,2,0,"连环刺","攻击|Cffffc9266%|r概率对目标范围造成伤害。\n\n触发后2s内|Cffffc926夺命刺|r概率增加|Cffffc92610%|r。","ReplaceableTextures\\CommandButtons\\BTNS076.blp")
call InitAbilityData('S078',3,1,1,0,5,6,2,8,"彗星灭世","蓄力3秒后，对目标范围造成伤害，可再次使用技能提前终止蓄力。蓄力时间越长伤害越高","ReplaceableTextures\\CommandButtons\\BTNS078.blp")
call InitAbilityData('S079',3,1,1,6,7,8,2,8,"龙神陨光","蓄力3秒后，对直线范围造成伤害，可再次使用技能提前终止蓄力。蓄力时间越长伤害越高","ReplaceableTextures\\CommandButtons\\BTNS079.blp")
call InitAbilityData('S081',3,1,1,0,0,0,2,8,"真空领域","将目标范围内的所有单位聚卷入中心，每|Cff00bfff0.5|r秒造成伤害。","ReplaceableTextures\\CommandButtons\\BTNS081.blp")
call InitAbilityData('S083',2,1,1,0,0,1,2,8,"十方飓风破","自身每|Cff00bfff0.75|r秒向周围逸散暴风，造成伤害。","ReplaceableTextures\\CommandButtons\\BTNS083.blp")
call InitAbilityData('S095',1,1,1,4,5,6,2,0,"佛陀法身","被攻击|Cff00bfff8%|r概率触对周围敌人伤害","ReplaceableTextures\\CommandButtons\\BTNS095.blp")
call InitAbilityData('S097',1,1,5,0,0.5,1,2,0,"神怒","被攻击|Cffffcc0016|r|Cfff0f0f0次|r对自身范围内敌人造成伤害","ReplaceableTextures\\CommandButtons\\BTNS097.blp")
call InitAbilityData('S099',1,1,0,0,0,0.66,0,0,"刚毅之心","","ReplaceableTextures\\CommandButtons\\BTNS099.blp")
call InitAbilityData('S102',1,1,1,1,1.3,1.5,2,0,"黑龙之灵","释放1条|Cff999999黑龙之灵|r，每秒对敌人造成伤害。","ReplaceableTextures\\CommandButtons\\BTNS102.blp")
call InitAbilityData('S118',1,1,0,0,0.4,0.6,0,0,"血脉之力","","ReplaceableTextures\\CommandButtons\\BTNS118.blp")
call InitAbilityData('S119',1,1,0,0.33,0.5,0.66,0,0,"嗜血","","ReplaceableTextures\\CommandButtons\\BTNS119.blp")
call InitAbilityData('S120',2,1,1,0,2,3,2,8,"撼地击","对自身周围造成伤害。\n\n|Cff00ff7f40%几率额外释放一次大范围撼地击。|r","ReplaceableTextures\\CommandButtons\\BTNS120.blp")
call InitAbilityData('S123',2,1,1,3,4,5,2,8,"冰暴术","自身周围每秒产生一次随机冰暴，造成伤害。","ReplaceableTextures\\CommandButtons\\BTNS123.blp")
call InitAbilityData('S127',2,1,0,0.2,0.28,0.36,0,10,"回春术","|CffFFBF005|r秒内回复|Cfff0f0f0大量生|r命值\n\n|Cff00ff7f效果不可叠加|r","ReplaceableTextures\\CommandButtons\\BTNS127.blp")
call InitAbilityData('S129',1,1,0,0.1,0.25,0.5,0,0,"贪婪","杀敌|Cffffc926金币|r奖励增加。","ReplaceableTextures\\CommandButtons\\BTNS129.blp")

...
call InitAbilityData('S503',1,0,99,1,0,0,2,0.2,"玉清合荒","周围800码范围内的敌/友军释放主动技能时，对自身周围造成（攻击+法强）*1法术伤害。","ReplaceableTextures\\CommandButtons\\BTNS503.blp")
call InitAbilityData('S504',3,0,1,2,0,0,1,10,"火尖枪舞","突刺至目标位置并向前方连续挥击，每次挥击造成攻击*2物理伤害。\n\n暴击达到30%时，额外造成一次刺击，造成攻击*8物理伤害。","ReplaceableTextures\\CommandButtons\\BTNS504.blp")
call InitAbilityData('S505',2,0,2,4,0,0,1,12,"一气化三清","幻化6个无法移动的分身，每个分身拥有70%攻击力。\n4秒后分身爆炸，对周围400码造成4*法强法术伤害。","ReplaceableTextures\\CommandButtons\\BTNS505.blp")
call InitAbilityData('S506',1,0,0,0,0,0,1,0,"斩仙飞刀","斩杀低于15%最大生命值的敌人。","ReplaceableTextures\\CommandButtons\\BTNS506.blp")
call InitAbilityData('S507',1,0,0,0,0,0,1,0,"万物亲和","每5秒回复20%最大生命值\n\n物穿>30%:召唤物伤害+30%\n法穿>30%:召唤物数量+2","ReplaceableTextures\\CommandButtons\\BTNS507.blp")
call InitAbilityData('S508',1,0,2,6,0,0,1,0,"镜花之舞","每次触发被动技能可积累1层妖狐印记，达到7层时向周围释放镜花之舞。\n每层妖狐印记提高10%攻击速度，镜花之舞造成法强*6法术伤害。","ReplaceableTextures\\CommandButtons\\BTNS508.blp")
call InitAbilityData('S509',1,0,0,0,0,0,1,0,"奕剑之道","奕剑之道，在于无招。\n普攻伤害+30%\n\n普攻伤害超过120%时，物理伤害+30%。","ReplaceableTextures\\CommandButtons\\BTNS509.blp")
call InitAbilityData('S510',2,0,0,0,0,0,1,2,"八九玄功","使用后依次变幻形态，并获得相应加成：\n金龙形态：暴击+10%\n白虎形态：攻速+45%\n人形态：冷却-10%","ReplaceableTextures\\CommandButtons\\BTNS510.blp")
call InitAbilityData('S511',1,0,0,0,0,0,1,0,"命途多舛","释放普通技能有50%几率失败，但成功了将增加2%伤害加成，上限150%。","ReplaceableTextures\\CommandButtons\\BTNS511.blp")
call InitAbilityData('S512',4,0,0,0,0,0,1,120,"天王宝塔","掷出天王宝塔镇压目标，增加与自身生命值/4攻击力。\n\n无法镇压Boss单位。","ReplaceableTextures\\CommandButtons\\BTNS512.blp")
call InitAbilityData('S513',3,0,0,0,0,0,1,12,"身外法身","使用毫毛在目标地点幻化一个法身，可重复施放你的技能，但只造成50%伤害。\n\n法身无法攻击，不可选取，不受攻击。","ReplaceableTextures\\CommandButtons\\BTNS513.blp")

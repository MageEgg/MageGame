...
call InitAbilityData('S082',2,3,1,2.5,0,0,1,8,"雷神之子","召唤4个雷球，每个雷球雷球，每|Cffff80000.75|r秒对800码随机目标周围发起范围攻击，造成|Cffff8000攻击*2.5|r物理伤害。\n\n|Cff00bfff攻击越高，雷球持续时间越长。|r","ReplaceableTextures\\CommandButtons\\BTNS082.blp")
...
call InitAbilityData('S515',1,0,2,8,0,0,2,0,"日月珠","每次|Cff00bfff施法|r凝聚|Cff00bfff1|r颗日月珠环绕自身，数量达到|Cff00bfff8|r颗时，向攻击目标造成|Cff00bfff法强*8|r范围伤害。","ReplaceableTextures\\CommandButtons\\BTNS515.blp")

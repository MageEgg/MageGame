...
call InitAbilityData('S002',1,1,0,0,0,0,0,6,"夺天一击","每6秒，必定触发|Cffff800012倍|r致命一击","ReplaceableTextures\\CommandButtons\\BTNS002.blp")
...
call InitAbilityData('S006',8,2,1,10,0,0,1,6,"无影杀","对目标范围内每个怪物进行攻击，造成|Cffff8000攻击*8|r物理伤害，附带|Cffff8000普攻效果|r。","ReplaceableTextures\\CommandButtons\\BTNS006.blp")
call InitAbilityData('S007',1,3,0,0,0,0,0,0,"巨人之力","增加|Cffff8000100%|r普攻伤害，|Cffff8000-80%|r攻击速度","ReplaceableTextures\\CommandButtons\\BTNS007.blp")
...
call InitAbilityData('S010',1,4,0,0,0,0,0,0,"技击","普攻伤害|Cffff8000-20%|r,致命概率|Cffff8000+25%|r\n\n|Cff00ff7f致命一击仅能通过普攻触发，与暴击效果叠加。|r","ReplaceableTextures\\CommandButtons\\BTNS010.blp")
call InitAbilityData('S011',1,4,0,0,0,0,0,0,"寸劲","致命概率|Cffff8000-5%|r，致命倍率|Cffff8000+500%\n|r\n|Cff00ff7f致命一击仅能通过普攻触发，与暴击效果叠加。|r","ReplaceableTextures\\CommandButtons\\BTNS011.blp")
...
call InitAbilityData('S014',1,7,0,0,0,0,0,0,"善武乏谋","法术伤害|Cffff8000-30%|r，致命倍率|Cffff8000+400%|r\n\n|Cff00ff7f致命一击仅能通过普攻触发，与暴击效果叠加。|r","ReplaceableTextures\\CommandButtons\\BTNS014.blp")
call InitAbilityData('S015',1,7,0,0,0,0,0,0,"洞察","致命概率|Cffff8000+10%|r，致命倍率|Cffff8000+250%|r\n\n|Cff00ff7f致命一击仅能通过普攻触发，与暴击效果叠加。|r","ReplaceableTextures\\CommandButtons\\BTNS015.blp")
call InitAbilityData('S016',1,7,0,0,0,0,0,0,"骁勇","增加|Cffff800030%|r普攻伤害","ReplaceableTextures\\CommandButtons\\BTNS016.blp")
call InitAbilityData('S018',2,1,1,6,0,0,1,8,"破甲阵","使用精湛的刀术对周围怪物造成造成|Cffff8000攻击*10|r物理伤害，3s内增加自身|Cffff800015%|r物理穿透。\n\n|Cff00ff7f效果可叠加|r","ReplaceableTextures\\CommandButtons\\BTNS018.blp")
call InitAbilityData('S019',1,2,0,0,0,0,0,0,"卸甲","增加|Cffff800025%|r护甲穿透","ReplaceableTextures\\CommandButtons\\BTNS019.blp")
call InitAbilityData('S020',1,3,0,0,0,0,0,0,"腐蚀","增加|Cffff800015%|r护甲穿透","ReplaceableTextures\\CommandButtons\\BTNS020.blp")
call InitAbilityData('S022',8,1,99,3,0,0,1,10,"强攻阵","对周围怪物造成|Cffff8000攻击*6|r+|Cff00bfff法强*6|r物理伤害，3s内增加|Cffff800010%|r暴击。\n\n|Cff00ff7f效果可叠加|r","ReplaceableTextures\\CommandButtons\\BTNS022.blp")
...
call InitAbilityData('S027',1,1,1,8,0,0,1,0,"九天御雷击","攻击|Cffff800010%|r概率对目标范围造成|Cffff8000攻击*8|r物理伤害","ReplaceableTextures\\CommandButtons\\BTNS027.blp")
call InitAbilityData('S028',1,1,2,8,0,0,2,0,"冥月流星落","攻击|Cff00bfff10%|r概率对目标范围造成|Cff00bfff法强*8|r法术伤害","ReplaceableTextures\\CommandButtons\\BTNS028.blp")
...
call InitAbilityData('S030',1,1,99,8,0,0,1,0,"三昧真火","每|Cffff80008|r次攻击释放三昧真火，对敌方造成|Cffff8000攻击*4|r+|Cff00bfff法强*6|r物理伤害","ReplaceableTextures\\CommandButtons\\BTNS030.blp")
...
call InitAbilityData('S035',1,3,2,8,0,0,2,0,"业火咒","每|Cff00bfff8|r次攻击施动业火咒术，对目标范围内造成|Cff00bfff法强*5|r法术伤害","ReplaceableTextures\\CommandButtons\\BTNS035.blp")
...
call InitAbilityData('S037',1,4,0,0,0,0,0,0,"轻灵","普攻伤害|Cffff8000-20%|r，攻击速度|Cffff8000+40%|r","ReplaceableTextures\\CommandButtons\\BTNS037.blp")
call InitAbilityData('S038',1,4,1,6,0,0,1,0,"罡风破","每|Cffff800012|r次攻击对目标范围造成|Cffff8000攻击*6|r物理伤害","ReplaceableTextures\\CommandButtons\\BTNS038.blp")
call InitAbilityData('S039',1,4,2,6,0,0,2,0,"他山之石","每|Cff00bfff12|r次攻击对目标范围造成|Cff00bfff法强*6|r法术伤害。","ReplaceableTextures\\CommandButtons\\BTNS039.blp")
...
call InitAbilityData('S043',1,7,1,3,0,0,2,0,"气流杀","攻击|Cffff800010%|r概率对目标范围造成|Cffff8000攻击*3|r法术伤害","ReplaceableTextures\\CommandButtons\\BTNS043.blp")
...
call InitAbilityData('S047',2,3,2,0.25,0,0,2,16,"毒体","开启后使周围地方单位进入|Cff00ff7f中毒状态|r，每秒造成|Cff00bfff法强*0.75|r法术伤害。\n\n|Cff00ff7f持续伤害最多可叠加8次。|r","ReplaceableTextures\\CommandButtons\\BTNS047.blp")
call InitAbilityData('S048',1,3,2,3,0,0,2,0,"狐媚术","攻击|Cff00bfff12.5%|r概率对目标范围施加一次|Cffff80c0魅惑|r，造成|Cff00bfff法强*3|r法术伤害，|Cff00bfff8|r秒内降低|Cff00bfff6%|r攻速及移动速度。\n\n|Cff00ff7f减速效果可叠加，上限8次|r","ReplaceableTextures\\CommandButtons\\BTNS048.blp")
call InitAbilityData('S049',2,3,2,1,0,0,2,8,"失心令","对周围敌人造成|Cff00bfff法强*3*魅惑层数|r法术伤害","ReplaceableTextures\\CommandButtons\\BTNS049.blp")
call InitAbilityData('S052',3,1,2,6,0,0,2,6,"神火天降","对目标范围内敌人造成|Cff00bfff法强*10|r法术伤害，所有技能|Cff00bfff冷却减少0.5秒|r。","ReplaceableTextures\\CommandButtons\\BTNS052.blp")
call InitAbilityData('S053',2,2,2,2,0,0,2,2,"落魂咒","对周围单位造成|Cff00bfff法强*4|r法术伤害，|Cff00bfff20%|r几率造成|Cff00bfff双倍|r伤害\n\n|Cff00ff7f固定冷却时间|r","ReplaceableTextures\\CommandButtons\\BTNS053.blp")
call InitAbilityData('S054',1,3,0,0,0,0,0,0,"法魂","不再享受冷却缩减效果，每|Cff00bfff0.8%冷却|r提高|Cff00bfff1%法强加成|r。","ReplaceableTextures\\CommandButtons\\BTNS054.blp")
...
call InitAbilityData('S061',1,1,0,0,0,0,0,0,"帝星","|Cff00BFFF60%|r概率额外施法|Cff00bfff3|r次","ReplaceableTextures\\CommandButtons\\BTNS061.blp")
...
call InitAbilityData('S068',1,3,0,0,0,0,0,0,"穿魂","增加|Cff00bfff15%|r法术穿透","ReplaceableTextures\\CommandButtons\\BTNS068.blp")
call InitAbilityData('S070',3,1,1,3,0,0,1,20,"暴风剑雨","对目标范围内怪物造成|Cffff80004次|r攻击，每次攻击造成|Cffff8000攻击*3|r物理伤害。\n\n|Cff00ff7f每25%攻速额外攻击1次。|r","ReplaceableTextures\\CommandButtons\\BTNS070.blp")
call InitAbilityData('S071',1,3,0,0,0,0,0,0,"妖之力","不再享受攻速加成。每|Cffff80004.4%攻速|r提供|Cffff80001%攻击|r加成","ReplaceableTextures\\CommandButtons\\BTNS071.blp")
call InitAbilityData('S073',2,2,1,4,0,0,1,12,"混元珠","掷出|Cffff80004颗|r混元宝珠围绕自身旋转，每次碰撞到怪物时造成|Cffff8000攻击*4|r物理伤害，并|Cffffcc00眩晕0.5秒|r。\n对|Cff00ff7f失明状态|r的怪物造成|Cffff8000额外30%物理伤害|r。\n\n|Cff00ff7f回收时重置戮目珠的技能冷却。|r","ReplaceableTextures\\CommandButtons\\BTNS073.blp")
call InitAbilityData('S074',3,3,1,4,0,0,1,6,"戮目珠","对目标范围掷出戮目珠，对碰撞到的怪物造成|Cffff8000攻击*4|r物理伤害，并使其进入|Cff00ff7f失明状态|r，攻击命中率降低30%，持续3秒。","ReplaceableTextures\\CommandButtons\\BTNS074.blp")
call InitAbilityData('S075',1,1,1,16,0,0,1,0,"夺命刺","攻击|Cffff800015%|r概率对目标造成|Cffff8000攻击*10|r物理伤害，\n\n触发后追加一次|Cff00bfff连环刺|r。|Cff00ff7f（需已学习连环刺）|r","ReplaceableTextures\\CommandButtons\\BTNS075.blp")
call InitAbilityData('S076',1,3,1,8,0,0,1,0,"连环刺","攻击|Cffff800015%|r概率对目标范围造成|Cffff8000AD*8|r物理伤害。\n\n触发后2s内|Cffff0000夺命刺|r概率增加|Cffff800010%|r。","ReplaceableTextures\\CommandButtons\\BTNS076.blp")
call InitAbilityData('S078',3,1,1,4,0,0,1,0,"彗星灭世","对目标范围造成|Cffff8000攻击*4*蓄力时间|r物理伤害。\n\n|Cff00ff7f攻击越高，蓄力时间越长。|r","ReplaceableTextures\\CommandButtons\\BTNS078.blp")
call InitAbilityData('S079',3,1,2,4,0,0,2,8,"龙神陨光","对前方造成|Cff00bfff法强*4*蓄力时间|r物理伤害。\n\n|Cff00ff7f法强越高，蓄力时间越长。|r","ReplaceableTextures\\CommandButtons\\BTNS079.blp")
call InitAbilityData('S080',3,2,1,2.5,0,0,1,8,"剑灵诛仙式","万剑出鞘，对目标范围造成|Cffff8000攻击*2.5|r物理伤害。\n\n|Cff00ff7f攻击越高，持续时间越长。|r","ReplaceableTextures\\CommandButtons\\BTNS080.blp")
call InitAbilityData('S081',3,2,2,2.5,0,0,2,8,"真空领域","将目标范围内的所有单位聚卷入中心，每|Cff00bfff0.5|r秒造成|Cff00bfff法强*2.5|r法术伤害。\n\n|Cff00ff7f法强越高，持续时间越长。|r","ReplaceableTextures\\CommandButtons\\BTNS081.blp")
...
call InitAbilityData('S087',2,2,0,0,0,0,0,7,"五行道兵","召唤1个五行道兵，提高附近友军|Cffff800020%攻速|r，|Cff00bfff5%冷却缩减|r，|Cffff80005%暴击|r。\n\n|Cff00ff7f效果可叠加。|r","ReplaceableTextures\\CommandButtons\\BTNS087.blp")
...
call InitAbilityData('S090',2,3,0,0,0,0,2,10,"噬魂龙魄","召唤1个噬魂龙魄，使周围600码单位生机骤减，每0.5秒造成|Cff00bfff法强*0.5|r法术伤害。\n\n|Cff00ff7f多个噬魂灵魄伤害可叠加。|r","ReplaceableTextures\\CommandButtons\\BTNS090.blp")
...
call InitAbilityData('S112',3,4,1,1,0,0,1,32,"机关塔","召唤1个机关塔，每秒向360°发射|Cffff80008|r支箭，每支箭造成|Cffff8000攻击*1|r物理伤害。","ReplaceableTextures\\CommandButtons\\BTNS112.blp")
...
call InitAbilityData('S115',3,4,1,4,0,0,1,8,"震天箭","向目标区域射出一支震天箭，造成|Cffff8000攻击*4|r物理伤害\n\n|Cff00ff7f距离越远伤害越高，最多造成200%伤害。|r","ReplaceableTextures\\CommandButtons\\BTNS115.blp")
...
call InitAbilityData('S117',1,4,2,3,0,0,2,0,"元气破","攻击|Cff00bfff15%|r几率对目标范围造成|Cff00bfff法强*3|r法术伤害，并回复|Cff00bfff10|r点蓝量","ReplaceableTextures\\CommandButtons\\BTNS117.blp")
...
call InitAbilityData('S121',1,6,0,0,0,0,0,0,"锁魂","增加|Cff00bfff10%|r法术穿透","ReplaceableTextures\\CommandButtons\\BTNS121.blp")
call InitAbilityData('S122',1,6,0,0,0,0,0,0,"破甲","增加|Cffff800010%|r护甲穿透","ReplaceableTextures\\CommandButtons\\BTNS122.blp")
call InitAbilityData('S123',2,7,2,6,0,0,2,8,"冰暴术","自身周围每秒产生一次随机冰暴，造成|Cff00bfff法强*6|r法术。","ReplaceableTextures\\CommandButtons\\BTNS123.blp")
call InitAbilityData('S124',5,7,2,6,0,0,2,8,"驭雷术","向目标投射一个电球，造成|Cff00bfff法强*6|r法术伤害。电球返回自身时，回复|Cff00bfff命中次数*5|r蓝量。\n\n|Cff00ff7f电球最多跳跃6次。|r","ReplaceableTextures\\CommandButtons\\BTNS124.blp")
...
call InitAbilityData('S127',2,7,0,0,0,0,0,10,"回春术","|CffFFBF005|r秒内回复|Cffffcc0060%|r最大生命值\n\n|Cff00ff7f效果不可叠加|r","ReplaceableTextures\\CommandButtons\\BTNS127.blp")
...
call InitAbilityData('S230',9,0,1,12,0,0,1,20,"血之裂痕","化身狴犴扑杀目标范围，造成|Cffff8000攻击*24|r物理伤害并|Cffffbf00眩晕|r3秒。","ReplaceableTextures\\CommandButtons\\BTNS230.blp")
...
call InitAbilityData('S237',2,0,0,0,0,0,0,20,"道法自然","持续时间内，|Cff00bfff冷却缩减+40%|r，每次释放技能增加自身|Cffffbf0010%|r伤害加成。","ReplaceableTextures\\CommandButtons\\BTNS237.blp")
call InitAbilityData('S238',2,0,1,2,0,0,1,20,"孔雀之魂","4秒内，冷却缩减+40%，每次释放技能增加自身10%伤害加成。","ReplaceableTextures\\CommandButtons\\BTNS238.blp")
...
call InitAbilityData('S501',2,0,1,2,0,0,1,12,"天罚连击","突刺至目标区域并挥砍|Cffff80003|r次，每次造成|Cffff8000攻击*3|r物理伤害。\n\n|Cffbbbbbb突破境界三：\n挥砍一段伤害+50%\n\n突破境界五：\n挥砍二段伤害+30%\n\n突破境界十：\n挥砍三段造成4秒眩晕|r","ReplaceableTextures\\CommandButtons\\BTNS501.blp")
call InitAbilityData('S502',5,0,1,2,0,0,1,10,"土遁袭杀","钻入地底突进至目标身后进行|Cffff80002次|r爪击，每次造成|Cffff8000攻击*3|r伤害。\n\n|Cff00ff7f每150%攻速增加一次爪击。\n\n|r|Cffbbbbbb境界三\n每140%攻速增加一次爪击。\n境界五	\n每130%攻速增加一次爪击。\n境界十\n每100%攻速增加一次爪击|r。\n","ReplaceableTextures\\CommandButtons\\BTNS502.blp")
call InitAbilityData('S503',1,0,99,1,0,0,2,0.2,"玉清合荒","若600码范围内，有敌/友军释放主动技能，你对自身周围造成|Cffffbf00（攻击+法强）*3|r法术伤害。\n\n|Cffbbbbbb境界三：\n冷却时间降低至4秒\n\n境界五：\n冷却时间降低至2秒\n\n境界七：\n移除冷却时间|r","ReplaceableTextures\\CommandButtons\\BTNS503.blp")
call InitAbilityData('S504',2,0,1,2,0,0,1,10,"火尖枪舞","突向前方瞬间刺击|Cffff80003|r次，每次造成|Cffff8000攻击*2|r物理伤害。\n\n|Cff00ff7f暴击≥30%|r：额外造成一次刺击，造成|Cffff8000攻击*8|r物理伤害。\n\n|Cffbbbbbb境界三\n刺击次数+1\n\n境界五\n刺击次数+1\n\n境界十\n刺击次数+2|r","ReplaceableTextures\\CommandButtons\\BTNS504.blp")
call InitAbilityData('S505',2,0,2,4,0,0,2,12,"一气化三清","幻化|Cffff80002|r个无法移动的分身，每个分身拥有|Cffff800070%攻击力|r。\n4秒后分身爆炸，造成|Cff00bfff法强*4|r法术伤害。\n\n|Cff00ff7f分身可触发致命一击及分裂效果\n\n|r|Cffbbbbbb境界三\n幻化3个分身\n\n境界五\n幻化4个分身\n\n境界十\n幻化6个分身|r","ReplaceableTextures\\CommandButtons\\BTNS505.blp")
call InitAbilityData('S506',1,0,0,0,0,0,0,0,"斩仙飞刀","斩杀低于|Cffffbf006%|r最大生命值的敌人。\n\n|Cffbbbbbb境界三\n斩杀血限提高至8%\n\n境界五\n斩杀血限提高至10%\n\n境界七\n斩杀血限提高至15%|r","ReplaceableTextures\\CommandButtons\\BTNS506.blp")
call InitAbilityData('S507',1,0,0,0,0,0,0,0,"万物亲和","每|Cffffbf0010|r秒回复|Cffffbf0020%最大生命值\n|r\n|Cff00ff7f物穿>30%:|r召唤物伤害+30%\n|Cff00ff7f法穿>30%:|r召唤物数量+1\n\n|Cffbbbbbb境界三\n间隔时间降低至6秒\n\n境界五\n间隔时间降低至4秒\n\n境界七\n间隔时间降低至2秒|r","ReplaceableTextures\\CommandButtons\\BTNS507.blp")
call InitAbilityData('S508',1,0,2,6,0,0,2,0,"镜花之舞","攻击|Cff00bfff10%|r概率积累|Cff00bfff1|r层|Cff00bfff妖狐印记|r，达到|Cff00bfff7|r层时向周围释放|Cff00bfff镜花之舞|r。\n每层妖狐印记提高|Cff00bfff6%|r攻击速度，镜花之舞造成|Cff00bfff法强*6|r法术伤害。\n\n|Cff00ff7f概率受天命影响。\n\n|r|Cffbbbbbb境界三\n每层妖狐印记提高9%攻速\n\n境界五\n每层妖狐印记提高12%攻速\n\n境界十\n镜花之舞造成法强*10法术伤害|r","ReplaceableTextures\\CommandButtons\\BTNS508.blp")
call InitAbilityData('S509',1,0,0,0,0,0,0,0,"奕剑之道","奕剑之道，在于无招。\n普攻伤害|Cffff8000+20%\n|r\n|Cff00ff7f普攻伤害>160%|r：物理伤害+30%。\n\n|Cffbbbbbb境界三\n普攻伤害加成提升至30%\n\n境界五\n普攻伤害加成提升至40%\n\n境界十\n攻击间隔-0.1|r","ReplaceableTextures\\CommandButtons\\BTNS509.blp")
call InitAbilityData('S510',2,0,0,0,0,0,0,2,"八九玄功","使用后依次|Cff00ff7f变幻形态|r，并获得相应加成：\n金龙形态：暴击|Cffffbf00+10%|r\n白虎形态：攻速|Cffff8000+45%|r\n人形态：冷却|Cff00bfff-10%\n\n|r|Cffbbbbbb境界三\n金龙形态下伤害减免+10%\n\n境界五\n白虎形态下闪避+10%\n\n境界十\n人形态伤害吸血+5%|r","ReplaceableTextures\\CommandButtons\\BTNS510.blp")
call InitAbilityData('S511',1,0,0,0,0,0,0,0,"命途多舛","释放|Cff00bfff主动技能|r有|Cff00bfff50%|r几率失败，|Cff00bfff50%|r几率大成功，该伤害提高|Cff00bfff140%|r。\n\n|Cffbbbbbb境界三\n大成功伤害+150%\n\n境界五\n大成功伤害+160%\n\n境界十\n大成功伤害+200%|r","ReplaceableTextures\\CommandButtons\\BTNS511.blp")
call InitAbilityData('S512',2,0,1,6,0,0,1,12,"天王宝塔","掷出天王宝塔镇压目标，造成|Cffff8000攻击*3|r物理伤害并|Cffffbf00眩晕|r2秒。\n\n|Cff00ff7f暴击>30%|r：伤害翻倍。\n\n|Cffbbbbbb境界三\n造成攻击*4物理伤害\n\n境界五\n造成攻击*5物理伤害\n\n境界十\n造成攻击*7物理伤害|r","ReplaceableTextures\\CommandButtons\\BTNS512.blp")
call InitAbilityData('S513',2,0,0,0,0,0,0,12,"身外法身","使用毫毛在目标地点|Cff00bfff幻化一个法身|r，可|Cff00bfff模仿你施放|r的|Cff00bfff主动伤害技能|r，但只造成|Cff00bfff30%伤害|r。\n\n|Cffbbbbbb法身无法攻击，不可选取，不受攻击。\n\n境界三\n法身释放技能造成40%伤害\n\n境界五\n法身释放技能造成50%伤害\n\n境界十\n法身释放技能造成60%伤害|r","ReplaceableTextures\\CommandButtons\\BTNS513.blp")
call InitAbilityData('S514',2,0,2,4,0,0,2,10,"冰封万里","对自身周围发动一次冰封术，造成|Cff00bfff法强*3|r法术伤害\n\n|Cff00ff7f冷却缩减>30%|r：额外发动一次冰暴，造成|Cff00bfff法强*8|r法术伤害。\n\n|Cffbbbbbb境界三：\n伤害范围+100%\n\n境界五\n冰封术造成法强*4法术伤害\n\n境界十\n冰封术造成法强*6法术伤害和2秒冰冻|r","ReplaceableTextures\\CommandButtons\\BTNS514.blp")
call InitAbilityData('S515',1,0,2,8,0,0,2,0,"日月珠","每次|Cff00bfff施法|r凝聚|Cff00bfff1|r颗日月珠环绕自身，数量达到|Cff00bfff8|r颗时，向攻击目标造成|Cff00bfff法强*8|r范围伤害。\n\n|Cffbbbbbb境界三\n触发条件降低至6颗\n\n境界五\n触发条件降低至4颗\n\n境界十\n触发条件降低至2颗|r","ReplaceableTextures\\CommandButtons\\BTNS515.blp")
call InitAbilityData('S516',2,0,0,0,0,0,0,30,"悔悟","自裁悔过，所有人回复|Cffffbf0050%|r生命，3秒内提高|Cffffbf0020%|r伤害加成。\n\n|Cff00ff7f悔过次数>10|r：增加自身当前攻击60%\n\n|Cffbbbbbb境界三\n回复满额生命\n\n境界五\n伤害加成提高至40%\n\n境界十\n伤害加成持续时间+1.5s|r","ReplaceableTextures\\CommandButtons\\BTNS516.blp")
call InitAbilityData('S517',1,0,0,0,0,0,0,0,"天资聪颖","每次学习技能获得|Cff00bfff200~800|r法强。\n\n|Cffbbbbbb境界三\n获得1本B级技能书\n\n境界五\n获得1本A级技能书\n\n境界十\n获得1本S级技能书|r","ReplaceableTextures\\CommandButtons\\BTNS517.blp")
call InitAbilityData('S518',1,0,0,0,0,0,0,0,"九转神功","每次突破境界|Cffffbf0040%|r概率获得额外|Cffffbf0010%|r收益\n\n|Cffbbbbbb境界三\n概率提升至70%\n\n境界五\n概率提升至100%\n\n境界十\n获得2个补天石|r","ReplaceableTextures\\CommandButtons\\BTNS518.blp")
call InitAbilityData('S519',1,0,2,2,0,0,2,0,"天眼神光","|CffFFBF00攻击或施法|r时，|Cffffbf005%|r几率开启天眼发射神光，造成|Cffff8000法强*3|r法术伤害。\n\n|Cffbbbbbb境界三\n施法100%几率开启天眼\n\n境界五\n攻击开启天眼几率翻倍\n\n境界十\n神光伤害翻倍|r","ReplaceableTextures\\CommandButtons\\BTNS519.blp")
call InitAbilityData('S520',1,0,0,0,0,0,0,0,"莲花化身","承受技能伤害减少|Cffffd24d40%|r。\n\n|Cffbbbbbb境界三\n承受物理伤害减少40%\n\n境界五\n免疫技能负面效果\n\n境界十\n受到技能伤害时，回复30%最大生命值|r","ReplaceableTextures\\CommandButtons\\BTNS520.blp")
call InitAbilityData('S521',2,0,0,0,0,0,0,40,"中秋快乐","每次使用获得一个|Cffffd24d随机月饼|r。\n|Cffffd24d蛋黄月饼|r：回复|Cffffd24d80%生命|r，解除异常状态\n|Cff00bfff豆沙月饼|r：回复|Cff00bfff70%蓝量|r\n|Cff00bfff果蔬月饼|r：法术伤害提高|Cff00bfff30%|r\n|Cffff8000鲜肉月饼|r：物理伤害提高|Cffff800030%|r\n|Cffff8000冰皮月饼|r：攻速|Cffff8000+50%|r\n\n|Cff00ff7f状态持续15秒。\n\n|r|Cffbbbbbb境界三\n获得1个技能附魔卷\n\n境界五\n技能冷却时间降低至45秒\n\n境界十\n技能冷却时间降至30秒|r","ReplaceableTextures\\CommandButtons\\BTNS521.blp")
call InitAbilityData('S522',1,0,0,0,0,0,0,0,"风雷咒术","获得风雷咒术加持，攻击速度提高|Cffff800050%|r。过快的攻击速度导致物理伤害降低50%。\n\n|Cffbbbbbb境界三\n攻击速度提高70%\n\n境界五\n攻击速度提高90%\n\n境界十\n攻击速度提高120%|r","ReplaceableTextures\\CommandButtons\\BTNS522.blp")


call InitAbilityData('S525',2,0,1,2,0,0,1,8,"攒心钉","发射|Cffff80003枚|r攒心钉，造成|Cffff8000攻击*1.5|r物理伤害，4s内降低10护甲。\n\n|Cff00ff7f效果不可叠加。\n\n|r|Cffbbbbbb境界三\n攒心钉数量+1\n\n境界五\n攒心钉数量+1\n\n境界十\n攒心钉数量+2|r","ReplaceableTextures\\CommandButtons\\BTNS525.blp")
call InitAbilityData('S526',1,0,1,1,0,0,1,6,"当头棒击","每6秒攻击对直线范围造成|Cffff8000攻击*4|r物理伤害。\n\n|Cffbbbbbb境界三\n冷却时间降低至4秒\n\n境界五\n冷却时间降低至2秒\n\n境界十\n当头棒击必定触发暴击|r","ReplaceableTextures\\CommandButtons\\BTNS526.blp")

call InitAbilityData('S528',1,0,0,0,0,0,0,0,"尚武乏谋","有什么问题是暴力不能解决的呢？\n物理伤害|Cffff8000+20%|r，法术伤害|Cff00bfff-30%\n\n|r|Cffbbbbbb境界三\n物理伤害提升至30%\n\n境界五\n物理伤害提升至40%\n\n境界十\n物理伤害提升至60%|r","ReplaceableTextures\\CommandButtons\\BTNS528.blp")
call InitAbilityData('S529',1,0,0,0,0,0,0,15,"神医救世","队友或你死亡时，直接复活。\n\n|cffbbbbbb境界三\n冷却时间降低至18秒\n\n境界五\n冷却时间降低至16秒\n\n境界十\n冷却时间降低至12秒","ReplaceableTextures\\CommandButtons\\BTNS529.blp")
call InitAbilityData('S530',1,0,0,0,0,0,0,0,"百发百中","攻击必定命中。\n\n|cffbbbbbb境界三\n触发致命一击时回复自身3%最大生命值\n\n境界五\n致命倍率+300%\n\n境界十\n领悟三重射，可触发攻击特效","ReplaceableTextures\\CommandButtons\\BTNS530.blp")
call InitAbilityData('S531',1,0,0,0,0,0,0,0,"料事如神","每次占星增加|Cff00bfff境界等级*300|r法强。\n\n|Cffbbbbbb境界三\n增加量提高至境界*400\n\n境界五\n增加量提高至境界*500\n\n境界十\n领悟大道，攻|r击10%概率造成法强*占星次数法术伤害","ReplaceableTextures\\CommandButtons\\BTNS531.blp")
    endfunction
endscope

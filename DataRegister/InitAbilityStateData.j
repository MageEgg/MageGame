...
call InitAbilityData('S512',3,0,0,0,0,0,1,12,"天王宝塔","掷出天王宝塔镇压目标，造成攻击*6物理伤害并眩晕2秒。\n暴击>30%时，伤害翻倍。","ReplaceableTextures\\CommandButtons\\BTNS512.blp")
...
call InitAbilityData('S516',2,0,0,0,0,0,1,30,"悔悟","自裁悔过，所有人回复满额生命，6秒内提高15%伤害加成。\n\n悔过次数>30：永久增加自身当前攻击60%","ReplaceableTextures\\CommandButtons\\BTNS516.blp")
call InitAbilityData('S517',1,0,0,0,0,0,1,0,"天资聪颖","每次学习技能获得一定法强永久加成。","ReplaceableTextures\\CommandButtons\\BTNS517.blp")
...
call InitAbilityData('S523',6,0,0,0,0,0,1,12,"狐媚术","回复目标30%生命并解除所有负面效果，4s内提高10%攻击和法强。","ReplaceableTextures\\CommandButtons\\BTNS523.blp")
call InitAbilityData('S524',6,0,0,0,0,0,1,180,"道友请留步","劝说目标队友分享属性：\n30%成功，该队友和你攻击及法强提高20%。\n40%暴力劝说，获得该队友40%攻击及法强。\n30%失败，队友获得你40%攻击及法强\n劝说效果持续3分钟。\n\n该技能冷却时间固定。","ReplaceableTextures\\CommandButtons\\BTNS524.blp")
...
call InitAbilityData('S527',6,0,0,0,0,0,1,30,"昏庸无道","处决一名队友，额外获得其30%攻击。","ReplaceableTextures\\CommandButtons\\BTNS527.blp")

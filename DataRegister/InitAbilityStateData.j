...
call InitAbilityData('S521',2,0,2,1.8,0,0,0,0,2,10,1,"月盈","每秒对周围单位造成|Cffffc926业力*200%|r技能伤害，持续|Cffffc9266秒|r。","ReplaceableTextures\\CommandButtons\\BTNS521.blp")
...
call InitAbilityData('S524',8,0,2,1.5,0,0,0,0,2,10,3,"道友请留步","对目标范围进行蛊惑，每秒造成|Cffffc926业力*130%|r技能伤害，持续|Cffffc9264|r秒。","ReplaceableTextures\\CommandButtons\\BTNS524.blp")
...
InitAbilityStringEx('S523',"回复50%生命","对目标周围单位造成攻击*750%技能伤害。（原：攻击加成效果+30%）","攻击加成效果+30%。（原：对目标周围单位造成攻击*750%技能伤害。）","","")
...
InitAbilityStringEx('S527',"处决目标获得神仙搭救，立即原地复活。","对处决目标600码范围内造成攻击*1200%伤害，（原：被处决队友8秒内提高24%攻击。）","被处决队友8秒内提高24%攻击。（原：对处决目标600码范围内造成攻击*1200%伤害。）","","")

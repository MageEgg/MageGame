...
call InitAbilityData('S075',1,5,1,1,2,3,4,0,1,0,"夺命刺","攻击|Cffffc9266%|r概率对目标范围造成额外伤害。","ReplaceableTextures\\CommandButtons\\BTNS075.blp")
call InitAbilityData('S076',3,3,1,0,0,1,2,0,1,0,"连环刺","对目标范围造成伤害。\n3s内|Cffffc926刺杀系技能|r触发概率|Cffffc926+6%|r。","ReplaceableTextures\\CommandButtons\\BTNS076.blp")
call InitAbilityData('S027',1,4,2,0,1,2,3,0,2,0,"九天御雷击","攻击|Cffffc9266%|r概率对目标范围造成额外伤害。","ReplaceableTextures\\CommandButtons\\BTNS027.blp")
call InitAbilityData('S028',8,5,2,1,2,3,4,0,2,0,"冥月流星落","对目标范围造成伤害。\n3s内|Cffffc926刺杀系技能|r触发概率|Cffffc926+6%|r。","ReplaceableTextures\\CommandButtons\\BTNS028.blp")
call InitAbilityData('S002',2,3,0,0,0,3,4,0,0,6,"夺天一击","|CffFFC926下一次攻击|r必定触发|Cffffc926致命一击|r。","ReplaceableTextures\\CommandButtons\\BTNS002.blp")
call InitAbilityData('S003',1,4,0,0,2,3,4,0,0,0,"残暴","攻击|Cffffc9266%|r概率造成|Cffffc926致命一击|r。|n|n|Cff00ff7f致命一击概率和倍率可叠加。|r","ReplaceableTextures\\CommandButtons\\BTNS003.blp")
call InitAbilityData('S004',1,5,0,1,2,3,4,0,0,0,"无情","攻击|Cffffc92615%|r概率造成|Cffffc926致命一击|r。|n|n|Cff00ff7f致命一击概率和倍率可叠加。|r","ReplaceableTextures\\CommandButtons\\BTNS004.blp")
call InitAbilityData('S006',8,4,1,0,1,2,3,0,1,6,"无影杀","对目标范围内怪物进行5次攻击，附带|Cffffc926普攻效果|r。","ReplaceableTextures\\CommandButtons\\BTNS006.blp")
call InitAbilityData('S070',8,2,1,0,0,0,1,0,1,20,"暴风剑雨","对目标范围内怪物造成|Cffff800014次|r攻击，附带|Cffffc926普攻效果|r","ReplaceableTextures\\CommandButtons\\BTNS070.blp")
call InitAbilityData('S052',1,5,2,1,2,3,4,0,2,6,"神火天降","每|Cff00bfff16|r次攻击施动神火天降，对目标范围内敌人造成伤害，所有技能|Cff00bfff冷却减少0.5秒|r。","ReplaceableTextures\\CommandButtons\\BTNS052.blp")
call InitAbilityData('S053',2,5,2,1,2,3,4,0,2,2,"落魂咒","对周围单位造成伤害，|Cff00bfff30%|r几率造成|Cff00bfff双倍|r伤害\n\n|Cff00ff7f不受冷却缩减影响|r","ReplaceableTextures\\CommandButtons\\BTNS053.blp")
call InitAbilityData('S080',3,2,1,0,0,0,1,0,1,8,"剑灵诛仙式","万剑出鞘，对目标范围造成伤害。","ReplaceableTextures\\CommandButtons\\BTNS080.blp")
call InitAbilityData('S007',1,2,99,0,0,0,4,0,2,0,"太清妙术","攻击|Cffffc9266%|r概率对目标范围造成额外伤害。\n触发后每秒回复|Cffffc9263点蓝量|r，|Cffffc926仙术系|r技能伤害|Cffffc926+20%|r，持续|Cffffc9266|r秒。","ReplaceableTextures\\CommandButtons\\BTNS007.blp")
call InitAbilityData('S011',1,4,99,0,2,3,4,0,2,0,"玄灵诀","攻击|Cffffc9266%|r概率对目标范围造成额外伤害。\n触发后|Cffffc926所有技能冷却|r降低|Cffffc9260.5|r秒。","ReplaceableTextures\\CommandButtons\\BTNS011.blp")
call InitAbilityData('S012',1,3,2,0,0,3,4,0,2,0,"龙之吼","攻击|Cffffc9266%|r概率对目标范围造成额外伤害。\n触发后|Cffffc9266|r秒内进入|Cffffc926龙神状态|r，|Cffffc926业力+20%|r。","ReplaceableTextures\\CommandButtons\\BTNS012.blp")
call InitAbilityData('S078',7,4,1,0,1,2,3,0,2,8,"彗星灭世","蓄力|Cffffd24d1.5|r秒后，对目标范围造成伤害。\n|CffFFC9263秒|r内每次攻击视为|Cffffc9262次攻击计数|r。","ReplaceableTextures\\CommandButtons\\BTNS078.blp")
call InitAbilityData('S079',3,5,2,1,2,3,4,0,2,8,"龙神陨光","蓄力|Cffffd24d3秒|r后，对直线范围造成伤害。","ReplaceableTextures\\CommandButtons\\BTNS079.blp")
call InitAbilityData('S010',1,3,2,0,0,1,2,0,2,0,"龙之怒","攻击|Cffffc9266%|r概率对目标范围造成伤害。\n触发后|Cffffc9266|r秒内进入|Cffffc926龙神状态|r，|Cffffc926攻击+20%|r。","ReplaceableTextures\\CommandButtons\\BTNS010.blp")
call InitAbilityData('S001',1,3,2,0,0,1,2,0,2,0,"南明离火","每|Cff00bfff16|r次攻击施动南明离火，对目标范围造成额外伤害","ReplaceableTextures\\CommandButtons\\BTNS001.blp")
call InitAbilityData('S005',8,5,2,1,2,3,4,0,2,0,"焚心咒","施动焚心咒术对目标范围造成伤害。\n3秒内每次攻击视为|Cffffc9262次攻击计数|r。","ReplaceableTextures\\CommandButtons\\BTNS005.blp")
call InitAbilityData('S035',1,5,1,1,2,3,4,0,1,0,"业火咒","每|Cff00bfff16|r次攻击施动业火咒术，对目标范围造成额外伤害","ReplaceableTextures\\CommandButtons\\BTNS035.blp")
call InitAbilityData('S030',3,3,1,0,0,1,2,0,1,0,"三昧真火","施动业三昧真火对目标范围造成伤害。\n3秒内每次攻击视为|Cffffc9262次攻击计数|r。","ReplaceableTextures\\CommandButtons\\BTNS030.blp")
call InitAbilityData('S073',1,4,1,0,1,2,3,0,1,12,"混元珠","攻击|Cffffc9266%|r概率掷出混元宝珠，|Cffffc926每次碰撞|r到怪物时造成伤害并|Cffffc926眩晕0.5秒|r。\n触发时|Cffffc926重置妖魔系|r技能冷却。","ReplaceableTextures\\CommandButtons\\BTNS073.blp")
call InitAbilityData('S074',3,5,1,1,2,3,4,0,1,6,"戮目珠","对目标范围掷出戮目宝珠，碰撞怪物时造成伤害，3s内增加自身|Cffffc92610%护甲穿透|r。\n\n|Cff00ff7f效果可叠加|r","ReplaceableTextures\\CommandButtons\\BTNS074.blp")
call InitAbilityData('S013',1,2,99,0,0,0,2,0,2,10,"轮回之狱","每|Cffffc92624次|r攻击对目标范围造成额外伤害并|Cffffc926眩晕1秒|r。","ReplaceableTextures\\CommandButtons\\BTNS013.blp")
call InitAbilityData('S022',8,2,5,0,0,1,2,0,2,10,"强攻阵","火莲降世，对周围怪物造成伤害，3s内增加|Cffffc92610%|r暴击。\n\n|Cff00ff7f效果可叠加|r","ReplaceableTextures\\CommandButtons\\BTNS022.blp")
call InitAbilityData('S102',1,4,5,0,2,3,4,0,1,0,"黑龙之灵","释放1条|Cff999999黑龙之灵|r，每秒对敌人造成伤害。\n该伤害触发|Cffffc926暴击|r时，|Cffffc926额外召唤|r1条持续3秒的黑龙之灵。冷却3秒","ReplaceableTextures\\CommandButtons\\BTNS102.blp")
call InitAbilityData('S081',8,2,5,0,0,0,1,0,1,8,"真空领域","将目标范围内的所有单位聚卷入中心，每|Cff00bfff0.5|r秒造成伤害。\n持续时间内，攻击附带|Cffffc926最大生命*0.2|r物理伤害","ReplaceableTextures\\CommandButtons\\BTNS081.blp")
call InitAbilityData('S083',2,4,1,0,1,2,3,0,1,8,"十方飓风破","自身每|Cff00bfff0.75|r秒向周围逸散暴风，造成伤害。\n持续时间内|Cffffc926闪避+15%|r。|n|Cff00ff7f效果不可叠加。|r","ReplaceableTextures\\CommandButtons\\BTNS083.blp")
call InitAbilityData('S095',1,2,5,0,0,0,4,0,2,0,"佛陀法身","被攻击|Cff00bfff8%|r概率触对周围敌人伤害","ReplaceableTextures\\CommandButtons\\BTNS095.blp")
call InitAbilityData('S095',1,5,5,1,2,3,4,0,2,0,"反震","被攻击|Cff00bfff8%|r概率触对周围敌人伤害","ReplaceableTextures\\CommandButtons\\BTNS095.blp")
call InitAbilityData('S014',1,5,2,1,2,3,4,0,1,0,"后发制人","|CffFFC926闪避|r时对周围敌人伤害。","ReplaceableTextures\\CommandButtons\\BTNS014.blp")
call InitAbilityData('S096',1,2,1,0,0,0,2,0,1,0,"酒仙剑舞","|CffFFC926闪避|r时对周围敌人伤害。","ReplaceableTextures\\CommandButtons\\BTNS096.blp")
call InitAbilityData('S097',1,3,5,0,0,1,2,0,1,0,"佛怒","被攻击|Cffffc92616次|r对自身范围内敌人造成伤害。\n触发后|Cffffc9266秒|r内进入|Cffffc926佛怒状态|r，释放|Cffffc926佛门系|r技能持续时间|Cffffc926+2秒|r。","ReplaceableTextures\\CommandButtons\\BTNS097.blp")
call InitAbilityData('S101',7,5,5,1,2,3,4,0,2,8,"雷光破","对目标范围造成造成伤害。\n|Cffffc9264秒|r内|Cffffc926佛门系|r触发概率|Cffffc926+6%|r。","ReplaceableTextures\\CommandButtons\\BTNS101.blp")
call InitAbilityData('S104',2,4,5,0,1,2,3,0,2,0,"熔炉之身","每0.8秒对自身范围内敌人造成伤害。\n该伤害|Cffffc926暴击|r时触发1次|Cffffc926佛门系|r被动。","ReplaceableTextures\\CommandButtons\\BTNS104.blp")
call InitAbilityData('S082',1,2,99,0,0,0,1,0,2,8,"雷神之子","每|Cffffc92610|r秒召唤|Cffffc9264朵|r雷云环绕自身，持续|Cffffc9266|r秒。\n|Cff00ff7f雷云继承英雄100%攻击速度。|r","ReplaceableTextures\\CommandButtons\\BTNS082.blp")
call InitAbilityData('S086',1,5,1,1,2,3,4,0,1,20,"幻影剑阵","召唤|Cffffc9263把|r飞剑环绕自身。\n|Cff00ff7f飞剑继承英雄100%攻速。|r","ReplaceableTextures\\CommandButtons\\BTNS086.blp")
call InitAbilityData('S089',2,4,99,0,1,2,3,0,1,16,"天神道兵","召唤1个天神道兵。道兵|Cffffc926每次攻击|r伤害递增|Cffffc92610%|r，上限|Cffffc92650%|r。\n|Cff00ff7f道兵继承英雄100%攻速。|r","ReplaceableTextures\\CommandButtons\\BTNS089.blp")
call InitAbilityData('S090',8,3,2,0,0,1,2,0,2,10,"噬魂龙魄","召唤1个噬魂龙魄，使其周围600码单位生机骤减，每0.5秒造成伤害。\n\n|Cff00ff7f多个噬魂灵魄伤害可叠加。|r","ReplaceableTextures\\CommandButtons\\BTNS090.blp")
...
InitAbilityStringEx('S506',"斩杀血限提高至8%","斩杀血限提高至10%","斩杀血限提高至12%","","")
InitAbilityStringEx('S507',"回复量+5%","回复量+5%","回复量+10%","","")
InitAbilityStringEx('S508',"每层妖狐印记提高9%攻速","每层妖狐印记提高12%攻速","镜花之舞造成攻击*800%法术伤害","","")
InitAbilityStringEx('S509',"心剑状态下攻击速度+20%","攻击间隔-0.1","心剑状态下，攻击6%概率凝聚残影，对敌人造成攻击*100%伤害","","")
InitAbilityStringEx('S510',"金龙形态下物理抵抗+10%","白虎形态下闪避+10%","人形态法术伤害+20%","","")
InitAbilityStringEx('S511',"大成功伤害提高至180%","大成功伤害提高至210%","大成功伤害提高至300%","","")
InitAbilityStringEx('S512',"造成攻击*300%伤害","造成攻击*400%伤害","造成攻击*600%伤害","","")
InitAbilityStringEx('S513',"法身释放技能造成60%伤害","法身释放技能造成70%伤害","法身释放技能造成100%伤害","","")
InitAbilityStringEx('S514',"伤害范围+100%","冰封术造成攻击*300%伤害","冰封术造成攻击*400%法术伤害和2秒冰冻","","")
InitAbilityStringEx('S515',"日月珠造成攻击*250%伤害","日月珠造成攻击*350%伤害","日月珠造成攻击*600%伤害","","")
...
InitAbilityStringEx('S520',"法抗+12%","免疫技能负面效果","受到技能伤害时，回复30%最大生命值","","")

...
call InitAbilityData('S048',1,1,1,2,2.5,3,4,6,2,0,"狐媚术","攻击|Cffffc9266%|r概率对目标范围造成魅惑状态及伤害，3秒内降低|Cffffc92620%|r攻速及移动速度。","ReplaceableTextures\\CommandButtons\\BTNS048.blp")
...
call InitAbilityData('S079',3,1,1,4,4.5,5,6,7,2,8,"龙神陨光","蓄力|Cffffd24d2秒|r后，对直线范围造成伤害。","ReplaceableTextures\\CommandButtons\\BTNS079.blp")

...
library StringFormula requires YDWEBase
    ...
    private struct FormulaMatrix extends array [MAX_INSTANCES]
        ...
        static method memory takes integer lingth, string formStr, ItemIdMatrix eventually returns thistype
            ...
            set this.model      = "Abilities\\Spells\\Items\\AIam\\AIamTarget.mdl"
    ...
    private struct Sorting
        ...
        static method create takes integer type1, integer n1, integer type2, integer n2, integer type3, integer n3, integer type4, integer n4, integer type5, integer n5, integer type6, integer n6, integer type7, integer n7 returns thistype
    ...
    private function CraftItem takes nothing returns nothing
        ...
        //BJDebugMsg(GetUnitName(caster)+GetItemName(article))
        //* Check Slots
        set i = 0
        loop
            exitwhen i == 6
    ...
    function FormulaVerify takes nothing returns nothing
        if  ItemIdMatrix.exists(GetItemTypeId(GetManipulatedItem())) == true then
            CraftItem()
        endif
    endfunction
    ...
    function NewItemsFormula takes integer type1, integer n1, integer type2, integer n2, integer type3, integer n3,   integer type4, integer n4, integer type5, integer n5, integer type6, integer n6, integer eventually returns nothing
    ...
    function AddItemFormula takes int id1,int id2,int id3,int id4,int id5,int id6,int newid returns nothing
        call NewItemsFormula(id1,1,id2,1,id3,1,id4,1,id5,1,id6,1,newid)
    endfunction

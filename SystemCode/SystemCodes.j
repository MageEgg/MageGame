...
//UnitPoolAddUnitType( HeroPool, 'H028', 1 )
    ...
    scope ItemPool
        ...
        function InitUnitPoolFunc()
            ...
            RegisterItemPool(1,'IN01',4)
            RegisterItemPool(1,'IN02',4)
            RegisterItemPool(1,'IN03',4)
            RegisterItemPool(1,'IN04',1)
            RegisterItemPool(1,'IN05',1)
            RegisterItemPool(1,'IN06',1)
            RegisterItemPool(1,'IN07',2)
            RegisterItemPool(1,'IN08',2)
            RegisterItemPool(1,'IN09',3)
            RegisterItemPool(1,'IN10',2)
            RegisterItemPool(1,'IN11',2)
            RegisterItemPool(1,'IN12',2)
            RegisterItemPool(1,'IN13',4)
            RegisterItemPool(1,'IN14',1)
            RegisterItemPool(1,'IN15',1)
            RegisterItemPool(1,'IN16',1)
            RegisterItemPool(1,'IN17',2)
            RegisterItemPool(1,'IN18',2)
            RegisterItemPool(2,'IF01',3)
            RegisterItemPool(2,'IF02',3)
            RegisterItemPool(2,'IF03',1)
            RegisterItemPool(2,'IF04',1)
            RegisterItemPool(2,'IF05',1)
            RegisterItemPool(2,'IF06',1)
            RegisterItemPool(2,'IF07',3)
            RegisterItemPool(2,'IF08',3)
            RegisterItemPool(2,'IF09',1)
            RegisterItemPool(2,'IF10',1)
            RegisterItemPool(2,'IF11',2)
            RegisterItemPool(2,'IF12',1)
            RegisterItemPool(2,'IF13',3)
            RegisterItemPool(2,'IF14',2)
            RegisterItemPool(2,'IF15',1)
            RegisterItemPool(2,'IF16',2)
            RegisterItemPool(2,'IF17',1)
            RegisterItemPool(2,'IF18',2)
            RegisterItemPool(2,'IF19',1)
            RegisterItemPool(2,'IF20',3)
            RegisterItemPool(2,'IF21',1)
            RegisterItemPool(2,'IF22',3)
            RegisterItemPool(2,'IF23',1)
            RegisterItemPool(2,'IF24',2)
            RegisterItemPool(2,'IF25',2)
